...
public class V4VmOpenApiWebPageChannel   {
  ...
  public V4VmOpenApiWebPageChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V4VmOpenApiWebPageChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V4VmOpenApiWebPageChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V4VmOpenApiWebPageChannel addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V4VmOpenApiWebPageChannel addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V4VmOpenApiWebPageChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V4VmOpenApiWebPageChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V4VmOpenApiWebPageChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V4VmOpenApiWebPageChannel addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiWebPageChannel v4VmOpenApiWebPageChannel = (V4VmOpenApiWebPageChannel) o;
    return Objects.equals(this.id, v4VmOpenApiWebPageChannel.id) &&
        Objects.equals(this.serviceChannelType, v4VmOpenApiWebPageChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v4VmOpenApiWebPageChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v4VmOpenApiWebPageChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v4VmOpenApiWebPageChannel.serviceChannelDescriptions) &&
        Objects.equals(this.urls, v4VmOpenApiWebPageChannel.urls) &&
        Objects.equals(this.supportPhones, v4VmOpenApiWebPageChannel.supportPhones) &&
        Objects.equals(this.supportEmails, v4VmOpenApiWebPageChannel.supportEmails) &&
        Objects.equals(this.languages, v4VmOpenApiWebPageChannel.languages) &&
        Objects.equals(this.webPages, v4VmOpenApiWebPageChannel.webPages) &&
        Objects.equals(this.serviceHours, v4VmOpenApiWebPageChannel.serviceHours) &&
        Objects.equals(this.publishingStatus, v4VmOpenApiWebPageChannel.publishingStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, serviceChannelType, organizationId, serviceChannelNames, serviceChannelDescriptions, urls, supportPhones, supportEmails, languages, webPages, serviceHours, publishingStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V4VmOpenApiWebPageChannel {\n");
