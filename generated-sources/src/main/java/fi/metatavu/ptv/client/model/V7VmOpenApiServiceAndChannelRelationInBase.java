...
public class V7VmOpenApiServiceAndChannelRelationInBase {
  @JsonProperty("deleteAllChannelRelations")
  private Boolean deleteAllChannelRelations = null;

  @JsonProperty("channelRelations")
  private List<V7VmOpenApiServiceServiceChannelInBase> channelRelations = null;

  public V7VmOpenApiServiceAndChannelRelationInBase deleteAllChannelRelations(Boolean deleteAllChannelRelations) {
  ...
  **/
  ...
  public V7VmOpenApiServiceAndChannelRelationInBase channelRelations(List<V7VmOpenApiServiceServiceChannelInBase> channelRelations) {
    this.channelRelations = channelRelations;
    return this;
  }

  public V7VmOpenApiServiceAndChannelRelationInBase addChannelRelationsItem(V7VmOpenApiServiceServiceChannelInBase channelRelationsItem) {
    if (this.channelRelations == null) {
      this.channelRelations = new ArrayList<V7VmOpenApiServiceServiceChannelInBase>();
    }
  ...
  **/
  ...
  public List<V7VmOpenApiServiceServiceChannelInBase> getChannelRelations() {
    return channelRelations;
  }

  public void setChannelRelations(List<V7VmOpenApiServiceServiceChannelInBase> channelRelations) {
    this.channelRelations = channelRelations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiServiceAndChannelRelationInBase v7VmOpenApiServiceAndChannelRelationInBase = (V7VmOpenApiServiceAndChannelRelationInBase) o;
    return Objects.equals(this.deleteAllChannelRelations, v7VmOpenApiServiceAndChannelRelationInBase.deleteAllChannelRelations) &&
        Objects.equals(this.channelRelations, v7VmOpenApiServiceAndChannelRelationInBase.channelRelations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiServiceAndChannelRelationInBase {\n");
