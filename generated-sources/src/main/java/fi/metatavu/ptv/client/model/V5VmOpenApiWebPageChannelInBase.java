 ...
 */
@ApiModel(description = "OPEN API V5 - View Model of web page channel for IN api - base")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-05-04T15:53:23.977+03:00")
public class V5VmOpenApiWebPageChannelInBase   {
  ...
  public V5VmOpenApiWebPageChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V5VmOpenApiWebPageChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V5VmOpenApiWebPageChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V5VmOpenApiWebPageChannelInBase addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V5VmOpenApiWebPageChannelInBase addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V5VmOpenApiWebPageChannelInBase addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V5VmOpenApiWebPageChannelInBase addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase deleteAllSupportEmails(Boolean deleteAllSupportEmails) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelInBase deleteAllSupportPhones(Boolean deleteAllSupportPhones) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiWebPageChannelInBase v5VmOpenApiWebPageChannelInBase = (V5VmOpenApiWebPageChannelInBase) o;
    return Objects.equals(this.sourceId, v5VmOpenApiWebPageChannelInBase.sourceId) &&
        Objects.equals(this.organizationId, v5VmOpenApiWebPageChannelInBase.organizationId) &&
        Objects.equals(this.serviceChannelDescriptions, v5VmOpenApiWebPageChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.serviceChannelNames, v5VmOpenApiWebPageChannelInBase.serviceChannelNames) &&
        Objects.equals(this.urls, v5VmOpenApiWebPageChannelInBase.urls) &&
        Objects.equals(this.supportPhones, v5VmOpenApiWebPageChannelInBase.supportPhones) &&
        Objects.equals(this.supportEmails, v5VmOpenApiWebPageChannelInBase.supportEmails) &&
        Objects.equals(this.languages, v5VmOpenApiWebPageChannelInBase.languages) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiWebPageChannelInBase.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v5VmOpenApiWebPageChannelInBase.isVisibleForAll) &&
        Objects.equals(this.deleteAllSupportEmails, v5VmOpenApiWebPageChannelInBase.deleteAllSupportEmails) &&
        Objects.equals(this.deleteAllSupportPhones, v5VmOpenApiWebPageChannelInBase.deleteAllSupportPhones);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelDescriptions, serviceChannelNames, urls, supportPhones, supportEmails, languages, publishingStatus, isVisibleForAll, deleteAllSupportEmails, deleteAllSupportPhones);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiWebPageChannelInBase {\n");
