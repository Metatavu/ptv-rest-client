 ...
 */
@ApiModel(description = "OPEN API V4 - View Model of web page channel for IN api - base")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-04-10T07:12:40.139+03:00")
public class V4VmOpenApiWebPageChannelInBase   {
  ...
  public V4VmOpenApiWebPageChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V4VmOpenApiWebPageChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V4VmOpenApiWebPageChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V4VmOpenApiWebPageChannelInBase addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V4VmOpenApiWebPageChannelInBase addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V4VmOpenApiWebPageChannelInBase addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V4VmOpenApiWebPageChannelInBase addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase deleteAllWebPages(Boolean deleteAllWebPages) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase deleteAllSupportEmails(Boolean deleteAllSupportEmails) {
  ...
  **/
  ...
  public V4VmOpenApiWebPageChannelInBase deleteAllSupportPhones(Boolean deleteAllSupportPhones) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiWebPageChannelInBase v4VmOpenApiWebPageChannelInBase = (V4VmOpenApiWebPageChannelInBase) o;
    return Objects.equals(this.sourceId, v4VmOpenApiWebPageChannelInBase.sourceId) &&
        Objects.equals(this.organizationId, v4VmOpenApiWebPageChannelInBase.organizationId) &&
        Objects.equals(this.serviceChannelDescriptions, v4VmOpenApiWebPageChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.serviceChannelNames, v4VmOpenApiWebPageChannelInBase.serviceChannelNames) &&
        Objects.equals(this.urls, v4VmOpenApiWebPageChannelInBase.urls) &&
        Objects.equals(this.supportPhones, v4VmOpenApiWebPageChannelInBase.supportPhones) &&
        Objects.equals(this.supportEmails, v4VmOpenApiWebPageChannelInBase.supportEmails) &&
        Objects.equals(this.languages, v4VmOpenApiWebPageChannelInBase.languages) &&
        Objects.equals(this.publishingStatus, v4VmOpenApiWebPageChannelInBase.publishingStatus) &&
        Objects.equals(this.deleteAllWebPages, v4VmOpenApiWebPageChannelInBase.deleteAllWebPages) &&
        Objects.equals(this.deleteAllSupportEmails, v4VmOpenApiWebPageChannelInBase.deleteAllSupportEmails) &&
        Objects.equals(this.deleteAllSupportPhones, v4VmOpenApiWebPageChannelInBase.deleteAllSupportPhones);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelDescriptions, serviceChannelNames, urls, supportPhones, supportEmails, languages, publishingStatus, deleteAllWebPages, deleteAllSupportEmails, deleteAllSupportPhones);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V4VmOpenApiWebPageChannelInBase {\n");
