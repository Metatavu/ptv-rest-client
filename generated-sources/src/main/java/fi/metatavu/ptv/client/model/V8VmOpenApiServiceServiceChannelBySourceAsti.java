...
public class V8VmOpenApiServiceServiceChannelBySourceAsti {
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti serviceChannelSourceId(String serviceChannelSourceId) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V8VmOpenApiServiceServiceChannelBySourceAsti addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti extraTypes(List<VmOpenApiExtraType> extraTypes) {
    this.extraTypes = extraTypes;
    return this;
  }

  public V8VmOpenApiServiceServiceChannelBySourceAsti addExtraTypesItem(VmOpenApiExtraType extraTypesItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V8VmOpenApiServiceServiceChannelBySourceAsti addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti contactDetails(V8VmOpenApiContactDetailsInBase contactDetails) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti deleteAllDescriptions(Boolean deleteAllDescriptions) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti deleteAllExtraTypes(Boolean deleteAllExtraTypes) {
  ...
  **/
  ...
  public V8VmOpenApiServiceServiceChannelBySourceAsti deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiServiceServiceChannelBySourceAsti v8VmOpenApiServiceServiceChannelBySourceAsti = (V8VmOpenApiServiceServiceChannelBySourceAsti) o;
    return Objects.equals(this.serviceChannelSourceId, v8VmOpenApiServiceServiceChannelBySourceAsti.serviceChannelSourceId) &&
        Objects.equals(this.description, v8VmOpenApiServiceServiceChannelBySourceAsti.description) &&
        Objects.equals(this.serviceChargeType, v8VmOpenApiServiceServiceChannelBySourceAsti.serviceChargeType) &&
        Objects.equals(this.extraTypes, v8VmOpenApiServiceServiceChannelBySourceAsti.extraTypes) &&
        Objects.equals(this.serviceHours, v8VmOpenApiServiceServiceChannelBySourceAsti.serviceHours) &&
        Objects.equals(this.contactDetails, v8VmOpenApiServiceServiceChannelBySourceAsti.contactDetails) &&
        Objects.equals(this.deleteServiceChargeType, v8VmOpenApiServiceServiceChannelBySourceAsti.deleteServiceChargeType) &&
        Objects.equals(this.deleteAllDescriptions, v8VmOpenApiServiceServiceChannelBySourceAsti.deleteAllDescriptions) &&
        Objects.equals(this.deleteAllExtraTypes, v8VmOpenApiServiceServiceChannelBySourceAsti.deleteAllExtraTypes) &&
        Objects.equals(this.deleteAllServiceHours, v8VmOpenApiServiceServiceChannelBySourceAsti.deleteAllServiceHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiServiceServiceChannelBySourceAsti {\n");
