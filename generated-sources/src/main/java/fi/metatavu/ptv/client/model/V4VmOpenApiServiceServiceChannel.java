...
public class V4VmOpenApiServiceServiceChannel   {
  ...
  public V4VmOpenApiServiceServiceChannel serviceChannelId(String serviceChannelId) {
  ...
  **/
  ...
  public V4VmOpenApiServiceServiceChannel description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V4VmOpenApiServiceServiceChannel addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V4VmOpenApiServiceServiceChannel serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V4VmOpenApiServiceServiceChannel digitalAuthorizations(List<V4VmOpenApiFintoItem> digitalAuthorizations) {
    this.digitalAuthorizations = digitalAuthorizations;
    return this;
  }

  public V4VmOpenApiServiceServiceChannel addDigitalAuthorizationsItem(V4VmOpenApiFintoItem digitalAuthorizationsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiServiceServiceChannel v4VmOpenApiServiceServiceChannel = (V4VmOpenApiServiceServiceChannel) o;
    return Objects.equals(this.serviceChannelId, v4VmOpenApiServiceServiceChannel.serviceChannelId) &&
        Objects.equals(this.description, v4VmOpenApiServiceServiceChannel.description) &&
        Objects.equals(this.serviceChargeType, v4VmOpenApiServiceServiceChannel.serviceChargeType) &&
        Objects.equals(this.digitalAuthorizations, v4VmOpenApiServiceServiceChannel.digitalAuthorizations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V4VmOpenApiServiceServiceChannel {\n");
