...
import fi.metatavu.ptv.client.model.V7VmOpenApiServiceServiceChannelBySource;
...
public class V7VmOpenApiServiceAndChannelRelationBySourceInBase {
  @JsonProperty("deleteAllChannelRelations")
  private Boolean deleteAllChannelRelations = null;

  @JsonProperty("channelRelations")
  private List<V7VmOpenApiServiceServiceChannelBySource> channelRelations = null;

  public V7VmOpenApiServiceAndChannelRelationBySourceInBase deleteAllChannelRelations(Boolean deleteAllChannelRelations) {
  ...
  **/
  ...
  public V7VmOpenApiServiceAndChannelRelationBySourceInBase channelRelations(List<V7VmOpenApiServiceServiceChannelBySource> channelRelations) {
    this.channelRelations = channelRelations;
    return this;
  }

  public V7VmOpenApiServiceAndChannelRelationBySourceInBase addChannelRelationsItem(V7VmOpenApiServiceServiceChannelBySource channelRelationsItem) {
    if (this.channelRelations == null) {
      this.channelRelations = new ArrayList<V7VmOpenApiServiceServiceChannelBySource>();
    }
  ...
  **/
  ...
  public List<V7VmOpenApiServiceServiceChannelBySource> getChannelRelations() {
    return channelRelations;
  }

  public void setChannelRelations(List<V7VmOpenApiServiceServiceChannelBySource> channelRelations) {
    this.channelRelations = channelRelations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiServiceAndChannelRelationBySourceInBase v7VmOpenApiServiceAndChannelRelationBySourceInBase = (V7VmOpenApiServiceAndChannelRelationBySourceInBase) o;
    return Objects.equals(this.deleteAllChannelRelations, v7VmOpenApiServiceAndChannelRelationBySourceInBase.deleteAllChannelRelations) &&
        Objects.equals(this.channelRelations, v7VmOpenApiServiceAndChannelRelationBySourceInBase.channelRelations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiServiceAndChannelRelationBySourceInBase {\n");
