...
public class V8VmOpenApiContactDetails {
  @JsonProperty("emails")
  ...
  public V8VmOpenApiContactDetails emails(List<VmOpenApiLanguageItem> emails) {
    this.emails = emails;
    return this;
  }

  public V8VmOpenApiContactDetails addEmailsItem(VmOpenApiLanguageItem emailsItem) {
    if (this.emails == null) {
  ...
  **/
  ...
  public V8VmOpenApiContactDetails phoneNumbers(List<V4VmOpenApiPhone> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V8VmOpenApiContactDetails addPhoneNumbersItem(V4VmOpenApiPhone phoneNumbersItem) {
  ...
  **/
  ...
  public V8VmOpenApiContactDetails webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V8VmOpenApiContactDetails addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V8VmOpenApiContactDetails addresses(List<V7VmOpenApiAddressContact> addresses) {
    this.addresses = addresses;
    return this;
  }

  public V8VmOpenApiContactDetails addAddressesItem(V7VmOpenApiAddressContact addressesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiContactDetails v8VmOpenApiContactDetails = (V8VmOpenApiContactDetails) o;
    return Objects.equals(this.emails, v8VmOpenApiContactDetails.emails) &&
        Objects.equals(this.phoneNumbers, v8VmOpenApiContactDetails.phoneNumbers) &&
        Objects.equals(this.webPages, v8VmOpenApiContactDetails.webPages) &&
        Objects.equals(this.addresses, v8VmOpenApiContactDetails.addresses);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiContactDetails {\n");
