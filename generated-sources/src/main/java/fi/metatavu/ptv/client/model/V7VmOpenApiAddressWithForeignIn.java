...
public class V7VmOpenApiAddressWithForeignIn {
  @JsonProperty("type")
  ...
  public V7VmOpenApiAddressWithForeignIn type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public V7VmOpenApiAddressWithForeignIn subType(String subType) {
   ...
   * @return subType
  **/
  @ApiModelProperty(required = true, value = "Address sub type, Street, PostOfficeBox or Foreign.")
  ...
  public V7VmOpenApiAddressWithForeignIn postOfficeBoxAddress(VmOpenApiAddressPostOfficeBoxIn postOfficeBoxAddress) {
  ...
  **/
  ...
  public V7VmOpenApiAddressWithForeignIn streetAddress(VmOpenApiAddressStreetWithCoordinatesIn streetAddress) {
  ...
  **/
  ...
  public V7VmOpenApiAddressWithForeignIn foreignAddress(List<VmOpenApiLanguageItem> foreignAddress) {
    this.foreignAddress = foreignAddress;
    return this;
  }

  public V7VmOpenApiAddressWithForeignIn addForeignAddressItem(VmOpenApiLanguageItem foreignAddressItem) {
  ...
  **/
  ...
  public V7VmOpenApiAddressWithForeignIn country(String country) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiAddressWithForeignIn v7VmOpenApiAddressWithForeignIn = (V7VmOpenApiAddressWithForeignIn) o;
    return Objects.equals(this.type, v7VmOpenApiAddressWithForeignIn.type) &&
        Objects.equals(this.subType, v7VmOpenApiAddressWithForeignIn.subType) &&
        Objects.equals(this.postOfficeBoxAddress, v7VmOpenApiAddressWithForeignIn.postOfficeBoxAddress) &&
        Objects.equals(this.streetAddress, v7VmOpenApiAddressWithForeignIn.streetAddress) &&
        Objects.equals(this.foreignAddress, v7VmOpenApiAddressWithForeignIn.foreignAddress) &&
        Objects.equals(this.country, v7VmOpenApiAddressWithForeignIn.country);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiAddressWithForeignIn {\n");
