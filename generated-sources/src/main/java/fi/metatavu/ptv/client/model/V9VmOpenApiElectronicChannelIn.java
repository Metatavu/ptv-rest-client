 ...
 */
@ApiModel(description = "OPEN API V9 - View Model of electronic channel for IN api")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-10-05T18:15:03.681+03:00")
public class V9VmOpenApiElectronicChannelIn {
  ...
  public V9VmOpenApiElectronicChannelIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn organizationId(String organizationId) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn areaType(String areaType) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addAreasItem(VmOpenApiAreaIn areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn signatureQuantity(String signatureQuantity) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn requiresSignature(Boolean requiresSignature) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn requiresAuthentication(Boolean requiresAuthentication) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn webPage(List<VmOpenApiLanguageItem> webPage) {
    this.webPage = webPage;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addWebPageItem(VmOpenApiLanguageItem webPageItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn attachments(List<VmOpenApiAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addAttachmentsItem(VmOpenApiAttachment attachmentsItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn accessibilityClassificationLevel(String accessibilityClassificationLevel) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn wcagLevel(String wcagLevel) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn accessibilityStatementWebPage(List<V9VmOpenApiWebPage> accessibilityStatementWebPage) {
    this.accessibilityStatementWebPage = accessibilityStatementWebPage;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addAccessibilityStatementWebPageItem(V9VmOpenApiWebPage accessibilityStatementWebPageItem) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V9VmOpenApiElectronicChannelIn services(List<String> services) {
    this.services = services;
    return this;
  }

  public V9VmOpenApiElectronicChannelIn addServicesItem(String servicesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V9VmOpenApiElectronicChannelIn v9VmOpenApiElectronicChannelIn = (V9VmOpenApiElectronicChannelIn) o;
    return Objects.equals(this.sourceId, v9VmOpenApiElectronicChannelIn.sourceId) &&
        Objects.equals(this.organizationId, v9VmOpenApiElectronicChannelIn.organizationId) &&
        Objects.equals(this.serviceChannelDescriptions, v9VmOpenApiElectronicChannelIn.serviceChannelDescriptions) &&
        Objects.equals(this.serviceChannelNames, v9VmOpenApiElectronicChannelIn.serviceChannelNames) &&
        Objects.equals(this.areaType, v9VmOpenApiElectronicChannelIn.areaType) &&
        Objects.equals(this.areas, v9VmOpenApiElectronicChannelIn.areas) &&
        Objects.equals(this.signatureQuantity, v9VmOpenApiElectronicChannelIn.signatureQuantity) &&
        Objects.equals(this.requiresSignature, v9VmOpenApiElectronicChannelIn.requiresSignature) &&
        Objects.equals(this.requiresAuthentication, v9VmOpenApiElectronicChannelIn.requiresAuthentication) &&
        Objects.equals(this.webPage, v9VmOpenApiElectronicChannelIn.webPage) &&
        Objects.equals(this.attachments, v9VmOpenApiElectronicChannelIn.attachments) &&
        Objects.equals(this.supportPhones, v9VmOpenApiElectronicChannelIn.supportPhones) &&
        Objects.equals(this.supportEmails, v9VmOpenApiElectronicChannelIn.supportEmails) &&
        Objects.equals(this.serviceHours, v9VmOpenApiElectronicChannelIn.serviceHours) &&
        Objects.equals(this.accessibilityClassificationLevel, v9VmOpenApiElectronicChannelIn.accessibilityClassificationLevel) &&
        Objects.equals(this.wcagLevel, v9VmOpenApiElectronicChannelIn.wcagLevel) &&
        Objects.equals(this.accessibilityStatementWebPage, v9VmOpenApiElectronicChannelIn.accessibilityStatementWebPage) &&
        Objects.equals(this.publishingStatus, v9VmOpenApiElectronicChannelIn.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v9VmOpenApiElectronicChannelIn.isVisibleForAll) &&
        Objects.equals(this.services, v9VmOpenApiElectronicChannelIn.services) &&
        Objects.equals(this.validFrom, v9VmOpenApiElectronicChannelIn.validFrom) &&
        Objects.equals(this.validTo, v9VmOpenApiElectronicChannelIn.validTo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelDescriptions, serviceChannelNames, areaType, areas, signatureQuantity, requiresSignature, requiresAuthentication, webPage, attachments, supportPhones, supportEmails, serviceHours, accessibilityClassificationLevel, wcagLevel, accessibilityStatementWebPage, publishingStatus, isVisibleForAll, services, validFrom, validTo);
  }
  ...
  public String toString() {
    ...
    sb.append("class V9VmOpenApiElectronicChannelIn {\n");
