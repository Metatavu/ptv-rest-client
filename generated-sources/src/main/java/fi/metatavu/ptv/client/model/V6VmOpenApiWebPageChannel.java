...
public class V6VmOpenApiWebPageChannel   {
  ...
  public V6VmOpenApiWebPageChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V6VmOpenApiWebPageChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V6VmOpenApiWebPageChannel modified(OffsetDateTime modified) {
