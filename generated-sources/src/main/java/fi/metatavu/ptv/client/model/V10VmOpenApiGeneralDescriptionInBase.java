 ...
 */
@ApiModel(description = "OPEN API V10 - View Model of general description for IN api base (PUT)")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-07-08T12:51:13.642+03:00")
public class V10VmOpenApiGeneralDescriptionInBase {
  @JsonProperty("names")
  ...
  public V10VmOpenApiGeneralDescriptionInBase names(List<VmOpenApiLocalizedListItem> names) {
    this.names = names;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addNamesItem(VmOpenApiLocalizedListItem namesItem) {
    if (this.names == null) {
   ...
   * @return names
  **/
  @ApiModelProperty(value = "List of localized names. Possible type values are: Name, AlternativeName.")
  ...
  public V10VmOpenApiGeneralDescriptionInBase descriptions(List<VmOpenApiLocalizedListItem> descriptions) {
    this.descriptions = descriptions;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addDescriptionsItem(VmOpenApiLocalizedListItem descriptionsItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase serviceClasses(List<String> serviceClasses) {
    this.serviceClasses = serviceClasses;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addServiceClassesItem(String serviceClassesItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase ontologyTerms(List<String> ontologyTerms) {
    this.ontologyTerms = ontologyTerms;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addOntologyTermsItem(String ontologyTermsItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase targetGroups(List<String> targetGroups) {
    this.targetGroups = targetGroups;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addTargetGroupsItem(String targetGroupsItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase lifeEvents(List<String> lifeEvents) {
    this.lifeEvents = lifeEvents;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addLifeEventsItem(String lifeEventsItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase industrialClasses(List<String> industrialClasses) {
    this.industrialClasses = industrialClasses;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addIndustrialClassesItem(String industrialClassesItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase requirements(List<VmOpenApiLanguageItem> requirements) {
    this.requirements = requirements;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addRequirementsItem(VmOpenApiLanguageItem requirementsItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase legislation(List<V4VmOpenApiLaw> legislation) {
    this.legislation = legislation;
    return this;
  }

  public V10VmOpenApiGeneralDescriptionInBase addLegislationItem(V4VmOpenApiLaw legislationItem) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase generalDescriptionType(String generalDescriptionType) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase deleteAllLifeEvents(Boolean deleteAllLifeEvents) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase deleteAllIndustrialClasses(Boolean deleteAllIndustrialClasses) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase deleteAllLaws(Boolean deleteAllLaws) {
  ...
  **/
  ...
  public V10VmOpenApiGeneralDescriptionInBase deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V10VmOpenApiGeneralDescriptionInBase v10VmOpenApiGeneralDescriptionInBase = (V10VmOpenApiGeneralDescriptionInBase) o;
    return Objects.equals(this.names, v10VmOpenApiGeneralDescriptionInBase.names) &&
        Objects.equals(this.descriptions, v10VmOpenApiGeneralDescriptionInBase.descriptions) &&
        Objects.equals(this.serviceClasses, v10VmOpenApiGeneralDescriptionInBase.serviceClasses) &&
        Objects.equals(this.ontologyTerms, v10VmOpenApiGeneralDescriptionInBase.ontologyTerms) &&
        Objects.equals(this.targetGroups, v10VmOpenApiGeneralDescriptionInBase.targetGroups) &&
        Objects.equals(this.lifeEvents, v10VmOpenApiGeneralDescriptionInBase.lifeEvents) &&
        Objects.equals(this.industrialClasses, v10VmOpenApiGeneralDescriptionInBase.industrialClasses) &&
        Objects.equals(this.requirements, v10VmOpenApiGeneralDescriptionInBase.requirements) &&
        Objects.equals(this.type, v10VmOpenApiGeneralDescriptionInBase.type) &&
        Objects.equals(this.serviceChargeType, v10VmOpenApiGeneralDescriptionInBase.serviceChargeType) &&
        Objects.equals(this.legislation, v10VmOpenApiGeneralDescriptionInBase.legislation) &&
        Objects.equals(this.generalDescriptionType, v10VmOpenApiGeneralDescriptionInBase.generalDescriptionType) &&
        Objects.equals(this.publishingStatus, v10VmOpenApiGeneralDescriptionInBase.publishingStatus) &&
        Objects.equals(this.deleteAllLifeEvents, v10VmOpenApiGeneralDescriptionInBase.deleteAllLifeEvents) &&
        Objects.equals(this.deleteAllIndustrialClasses, v10VmOpenApiGeneralDescriptionInBase.deleteAllIndustrialClasses) &&
        Objects.equals(this.deleteAllLaws, v10VmOpenApiGeneralDescriptionInBase.deleteAllLaws) &&
        Objects.equals(this.deleteServiceChargeType, v10VmOpenApiGeneralDescriptionInBase.deleteServiceChargeType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(names, descriptions, serviceClasses, ontologyTerms, targetGroups, lifeEvents, industrialClasses, requirements, type, serviceChargeType, legislation, generalDescriptionType, publishingStatus, deleteAllLifeEvents, deleteAllIndustrialClasses, deleteAllLaws, deleteServiceChargeType);
  }
  ...
  public String toString() {
    ...
    sb.append("class V10VmOpenApiGeneralDescriptionInBase {\n");
