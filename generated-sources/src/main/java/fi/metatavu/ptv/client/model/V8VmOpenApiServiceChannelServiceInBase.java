 ...
 */
@ApiModel(description = "OPEN API V8 - View Model of service channel service  IN.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-08-06T13:25:17.639+03:00")
public class V8VmOpenApiServiceChannelServiceInBase {
  ...
  public V8VmOpenApiServiceChannelServiceInBase serviceId(String serviceId) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V8VmOpenApiServiceChannelServiceInBase addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase extraTypes(List<VmOpenApiExtraType> extraTypes) {
    this.extraTypes = extraTypes;
    return this;
  }

  public V8VmOpenApiServiceChannelServiceInBase addExtraTypesItem(VmOpenApiExtraType extraTypesItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V8VmOpenApiServiceChannelServiceInBase addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase contactDetails(V8VmOpenApiContactDetailsInBase contactDetails) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase deleteAllDescriptions(Boolean deleteAllDescriptions) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase deleteAllExtraTypes(Boolean deleteAllExtraTypes) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public V8VmOpenApiServiceChannelServiceInBase serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiServiceChannelServiceInBase v8VmOpenApiServiceChannelServiceInBase = (V8VmOpenApiServiceChannelServiceInBase) o;
    return Objects.equals(this.serviceId, v8VmOpenApiServiceChannelServiceInBase.serviceId) &&
        Objects.equals(this.description, v8VmOpenApiServiceChannelServiceInBase.description) &&
        Objects.equals(this.extraTypes, v8VmOpenApiServiceChannelServiceInBase.extraTypes) &&
        Objects.equals(this.serviceHours, v8VmOpenApiServiceChannelServiceInBase.serviceHours) &&
        Objects.equals(this.contactDetails, v8VmOpenApiServiceChannelServiceInBase.contactDetails) &&
        Objects.equals(this.deleteServiceChargeType, v8VmOpenApiServiceChannelServiceInBase.deleteServiceChargeType) &&
        Objects.equals(this.deleteAllDescriptions, v8VmOpenApiServiceChannelServiceInBase.deleteAllDescriptions) &&
        Objects.equals(this.deleteAllExtraTypes, v8VmOpenApiServiceChannelServiceInBase.deleteAllExtraTypes) &&
        Objects.equals(this.deleteAllServiceHours, v8VmOpenApiServiceChannelServiceInBase.deleteAllServiceHours) &&
        Objects.equals(this.serviceChargeType, v8VmOpenApiServiceChannelServiceInBase.serviceChargeType);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiServiceChannelServiceInBase {\n");
