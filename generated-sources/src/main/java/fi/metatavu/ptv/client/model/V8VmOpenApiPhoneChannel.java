...
public class V8VmOpenApiPhoneChannel {
  ...
  public V8VmOpenApiPhoneChannel id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel sourceId(String sourceId) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel organizationId(UUID organizationId) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V8VmOpenApiPhoneChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V8VmOpenApiPhoneChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel areaType(String areaType) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel areas(List<VmOpenApiArea> areas) {
    this.areas = areas;
    return this;
  }

  public V8VmOpenApiPhoneChannel addAreasItem(VmOpenApiArea areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel phoneNumbers(List<V4VmOpenApiPhoneWithType> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V8VmOpenApiPhoneChannel addPhoneNumbersItem(V4VmOpenApiPhoneWithType phoneNumbersItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V8VmOpenApiPhoneChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V8VmOpenApiPhoneChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V8VmOpenApiPhoneChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V8VmOpenApiPhoneChannel addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel services(List<V8VmOpenApiServiceChannelService> services) {
    this.services = services;
    return this;
  }

  public V8VmOpenApiPhoneChannel addServicesItem(V8VmOpenApiServiceChannelService servicesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPhoneChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiPhoneChannel v8VmOpenApiPhoneChannel = (V8VmOpenApiPhoneChannel) o;
    return Objects.equals(this.id, v8VmOpenApiPhoneChannel.id) &&
        Objects.equals(this.sourceId, v8VmOpenApiPhoneChannel.sourceId) &&
        Objects.equals(this.serviceChannelType, v8VmOpenApiPhoneChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v8VmOpenApiPhoneChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v8VmOpenApiPhoneChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v8VmOpenApiPhoneChannel.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v8VmOpenApiPhoneChannel.areaType) &&
        Objects.equals(this.areas, v8VmOpenApiPhoneChannel.areas) &&
        Objects.equals(this.phoneNumbers, v8VmOpenApiPhoneChannel.phoneNumbers) &&
        Objects.equals(this.supportEmails, v8VmOpenApiPhoneChannel.supportEmails) &&
        Objects.equals(this.languages, v8VmOpenApiPhoneChannel.languages) &&
        Objects.equals(this.webPages, v8VmOpenApiPhoneChannel.webPages) &&
        Objects.equals(this.serviceHours, v8VmOpenApiPhoneChannel.serviceHours) &&
        Objects.equals(this.services, v8VmOpenApiPhoneChannel.services) &&
        Objects.equals(this.publishingStatus, v8VmOpenApiPhoneChannel.publishingStatus) &&
        Objects.equals(this.modified, v8VmOpenApiPhoneChannel.modified);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiPhoneChannel {\n");
