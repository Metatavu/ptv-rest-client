...
public class V4VmOpenApiPhoneChannel   {
  ...
  public V4VmOpenApiPhoneChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V4VmOpenApiPhoneChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V4VmOpenApiPhoneChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel phoneNumbers(List<V4VmOpenApiPhoneWithType> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V4VmOpenApiPhoneChannel addPhoneNumbersItem(V4VmOpenApiPhoneWithType phoneNumbersItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V4VmOpenApiPhoneChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V4VmOpenApiPhoneChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V4VmOpenApiPhoneChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V4VmOpenApiPhoneChannel addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V4VmOpenApiPhoneChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiPhoneChannel v4VmOpenApiPhoneChannel = (V4VmOpenApiPhoneChannel) o;
    return Objects.equals(this.id, v4VmOpenApiPhoneChannel.id) &&
        Objects.equals(this.serviceChannelType, v4VmOpenApiPhoneChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v4VmOpenApiPhoneChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v4VmOpenApiPhoneChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v4VmOpenApiPhoneChannel.serviceChannelDescriptions) &&
        Objects.equals(this.phoneNumbers, v4VmOpenApiPhoneChannel.phoneNumbers) &&
        Objects.equals(this.supportEmails, v4VmOpenApiPhoneChannel.supportEmails) &&
        Objects.equals(this.languages, v4VmOpenApiPhoneChannel.languages) &&
        Objects.equals(this.webPages, v4VmOpenApiPhoneChannel.webPages) &&
        Objects.equals(this.serviceHours, v4VmOpenApiPhoneChannel.serviceHours) &&
        Objects.equals(this.publishingStatus, v4VmOpenApiPhoneChannel.publishingStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, serviceChannelType, organizationId, serviceChannelNames, serviceChannelDescriptions, phoneNumbers, supportEmails, languages, webPages, serviceHours, publishingStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V4VmOpenApiPhoneChannel {\n");
