...
public class VmOpenApiElectronicChannelIn   {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Service channel publishing status. Valid values are: Draft, Published, Deleted, Modified or OldPublished.")
  ...
  **/
  ...
  public VmOpenApiElectronicChannelIn deleteAllSupportContacts(Boolean deleteAllSupportContacts) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sourceId, vmOpenApiElectronicChannelIn.sourceId) &&
        ...
        Objects.equals(this.deleteAllSupportContacts, vmOpenApiElectronicChannelIn.deleteAllSupportContacts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelNames, serviceChannelDescriptions, signatureQuantity, requiresSignature, requiresAuthentication, urls, attachments, serviceHours, publishingStatus, supportContacts, deleteAllSupportContacts);
  }
