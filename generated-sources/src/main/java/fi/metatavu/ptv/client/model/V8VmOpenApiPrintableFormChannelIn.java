...
public class V8VmOpenApiPrintableFormChannelIn {
  ...
  public V8VmOpenApiPrintableFormChannelIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn organizationId(String organizationId) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn areaType(String areaType) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addAreasItem(VmOpenApiAreaIn areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn formIdentifier(List<VmOpenApiLanguageItem> formIdentifier) {
    this.formIdentifier = formIdentifier;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addFormIdentifierItem(VmOpenApiLanguageItem formIdentifierItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn deliveryAddresses(List<V8VmOpenApiAddressDeliveryIn> deliveryAddresses) {
    this.deliveryAddresses = deliveryAddresses;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addDeliveryAddressesItem(V8VmOpenApiAddressDeliveryIn deliveryAddressesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn channelUrls(List<VmOpenApiLocalizedListItem> channelUrls) {
    this.channelUrls = channelUrls;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addChannelUrlsItem(VmOpenApiLocalizedListItem channelUrlsItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn attachments(List<VmOpenApiAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addAttachmentsItem(VmOpenApiAttachment attachmentsItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V8VmOpenApiPrintableFormChannelIn services(List<String> services) {
    this.services = services;
    return this;
  }

  public V8VmOpenApiPrintableFormChannelIn addServicesItem(String servicesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiPrintableFormChannelIn v8VmOpenApiPrintableFormChannelIn = (V8VmOpenApiPrintableFormChannelIn) o;
    return Objects.equals(this.sourceId, v8VmOpenApiPrintableFormChannelIn.sourceId) &&
        Objects.equals(this.organizationId, v8VmOpenApiPrintableFormChannelIn.organizationId) &&
        Objects.equals(this.serviceChannelDescriptions, v8VmOpenApiPrintableFormChannelIn.serviceChannelDescriptions) &&
        Objects.equals(this.serviceChannelNames, v8VmOpenApiPrintableFormChannelIn.serviceChannelNames) &&
        Objects.equals(this.areaType, v8VmOpenApiPrintableFormChannelIn.areaType) &&
        Objects.equals(this.areas, v8VmOpenApiPrintableFormChannelIn.areas) &&
        Objects.equals(this.formIdentifier, v8VmOpenApiPrintableFormChannelIn.formIdentifier) &&
        Objects.equals(this.deliveryAddresses, v8VmOpenApiPrintableFormChannelIn.deliveryAddresses) &&
        Objects.equals(this.channelUrls, v8VmOpenApiPrintableFormChannelIn.channelUrls) &&
        Objects.equals(this.supportPhones, v8VmOpenApiPrintableFormChannelIn.supportPhones) &&
        Objects.equals(this.attachments, v8VmOpenApiPrintableFormChannelIn.attachments) &&
        Objects.equals(this.supportEmails, v8VmOpenApiPrintableFormChannelIn.supportEmails) &&
        Objects.equals(this.publishingStatus, v8VmOpenApiPrintableFormChannelIn.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v8VmOpenApiPrintableFormChannelIn.isVisibleForAll) &&
        Objects.equals(this.services, v8VmOpenApiPrintableFormChannelIn.services);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelDescriptions, serviceChannelNames, areaType, areas, formIdentifier, deliveryAddresses, channelUrls, supportPhones, attachments, supportEmails, publishingStatus, isVisibleForAll, services);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiPrintableFormChannelIn {\n");
