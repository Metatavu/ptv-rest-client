...
public class V6VmOpenApiPrintableFormChannel   {
  ...
  public V6VmOpenApiPrintableFormChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V6VmOpenApiPrintableFormChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V6VmOpenApiPrintableFormChannel modified(OffsetDateTime modified) {
