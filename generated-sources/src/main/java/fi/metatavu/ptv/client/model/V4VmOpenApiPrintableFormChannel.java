...
public class V4VmOpenApiPrintableFormChannel   {
  ...
  private V4VmOpenApiAddressWithCoordinates deliveryAddress = null;
  ...
  public V4VmOpenApiPrintableFormChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel formIdentifier(List<VmOpenApiLanguageItem> formIdentifier) {
    this.formIdentifier = formIdentifier;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addFormIdentifierItem(VmOpenApiLanguageItem formIdentifierItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel formReceiver(List<VmOpenApiLanguageItem> formReceiver) {
    this.formReceiver = formReceiver;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addFormReceiverItem(VmOpenApiLanguageItem formReceiverItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel deliveryAddress(V4VmOpenApiAddressWithCoordinates deliveryAddress) {
  ...
  **/
  ...
  public V4VmOpenApiAddressWithCoordinates getDeliveryAddress() {
    return deliveryAddress;
  }

  public void setDeliveryAddress(V4VmOpenApiAddressWithCoordinates deliveryAddress) {
    this.deliveryAddress = deliveryAddress;
  }

  public V4VmOpenApiPrintableFormChannel channelUrls(List<VmOpenApiLocalizedListItem> channelUrls) {
    this.channelUrls = channelUrls;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addChannelUrlsItem(VmOpenApiLocalizedListItem channelUrlsItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel attachments(List<VmOpenApiAttachmentWithType> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addAttachmentsItem(VmOpenApiAttachmentWithType attachmentsItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V4VmOpenApiPrintableFormChannel addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V4VmOpenApiPrintableFormChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiPrintableFormChannel v4VmOpenApiPrintableFormChannel = (V4VmOpenApiPrintableFormChannel) o;
    return Objects.equals(this.id, v4VmOpenApiPrintableFormChannel.id) &&
        Objects.equals(this.serviceChannelType, v4VmOpenApiPrintableFormChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v4VmOpenApiPrintableFormChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v4VmOpenApiPrintableFormChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v4VmOpenApiPrintableFormChannel.serviceChannelDescriptions) &&
        Objects.equals(this.formIdentifier, v4VmOpenApiPrintableFormChannel.formIdentifier) &&
        Objects.equals(this.formReceiver, v4VmOpenApiPrintableFormChannel.formReceiver) &&
        Objects.equals(this.deliveryAddress, v4VmOpenApiPrintableFormChannel.deliveryAddress) &&
        Objects.equals(this.channelUrls, v4VmOpenApiPrintableFormChannel.channelUrls) &&
        Objects.equals(this.attachments, v4VmOpenApiPrintableFormChannel.attachments) &&
        Objects.equals(this.supportPhones, v4VmOpenApiPrintableFormChannel.supportPhones) &&
        Objects.equals(this.supportEmails, v4VmOpenApiPrintableFormChannel.supportEmails) &&
        Objects.equals(this.languages, v4VmOpenApiPrintableFormChannel.languages) &&
        Objects.equals(this.webPages, v4VmOpenApiPrintableFormChannel.webPages) &&
        Objects.equals(this.serviceHours, v4VmOpenApiPrintableFormChannel.serviceHours) &&
        Objects.equals(this.publishingStatus, v4VmOpenApiPrintableFormChannel.publishingStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, serviceChannelType, organizationId, serviceChannelNames, serviceChannelDescriptions, formIdentifier, formReceiver, deliveryAddress, channelUrls, attachments, supportPhones, supportEmails, languages, webPages, serviceHours, publishingStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V4VmOpenApiPrintableFormChannel {\n");
