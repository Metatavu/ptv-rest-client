 ...
 */
@ApiModel(description = "OPEN API V7 - View Model of service location channel for IN api")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-10-23T08:36:23.831+03:00")
public class V7VmOpenApiServiceLocationChannelIn {
  ...
  public V7VmOpenApiServiceLocationChannelIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn organizationId(String organizationId) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn areaType(String areaType) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addAreasItem(VmOpenApiAreaIn areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn emails(List<VmOpenApiLanguageItem> emails) {
    this.emails = emails;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addEmailsItem(VmOpenApiLanguageItem emailsItem) {
    if (this.emails == null) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn faxNumbers(List<V4VmOpenApiPhoneSimple> faxNumbers) {
    this.faxNumbers = faxNumbers;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addFaxNumbersItem(V4VmOpenApiPhoneSimple faxNumbersItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn phoneNumbers(List<V4VmOpenApiPhone> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addPhoneNumbersItem(V4VmOpenApiPhone phoneNumbersItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn addresses(List<V7VmOpenApiAddressWithMovingIn> addresses) {
    this.addresses = addresses;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addAddressesItem(V7VmOpenApiAddressWithMovingIn addressesItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V7VmOpenApiServiceLocationChannelIn services(List<String> services) {
    this.services = services;
    return this;
  }

  public V7VmOpenApiServiceLocationChannelIn addServicesItem(String servicesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiServiceLocationChannelIn v7VmOpenApiServiceLocationChannelIn = (V7VmOpenApiServiceLocationChannelIn) o;
    return Objects.equals(this.sourceId, v7VmOpenApiServiceLocationChannelIn.sourceId) &&
        Objects.equals(this.organizationId, v7VmOpenApiServiceLocationChannelIn.organizationId) &&
        Objects.equals(this.serviceChannelNames, v7VmOpenApiServiceLocationChannelIn.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v7VmOpenApiServiceLocationChannelIn.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v7VmOpenApiServiceLocationChannelIn.areaType) &&
        Objects.equals(this.areas, v7VmOpenApiServiceLocationChannelIn.areas) &&
        Objects.equals(this.emails, v7VmOpenApiServiceLocationChannelIn.emails) &&
        Objects.equals(this.faxNumbers, v7VmOpenApiServiceLocationChannelIn.faxNumbers) &&
        Objects.equals(this.phoneNumbers, v7VmOpenApiServiceLocationChannelIn.phoneNumbers) &&
        Objects.equals(this.languages, v7VmOpenApiServiceLocationChannelIn.languages) &&
        Objects.equals(this.webPages, v7VmOpenApiServiceLocationChannelIn.webPages) &&
        Objects.equals(this.addresses, v7VmOpenApiServiceLocationChannelIn.addresses) &&
        Objects.equals(this.serviceHours, v7VmOpenApiServiceLocationChannelIn.serviceHours) &&
        Objects.equals(this.publishingStatus, v7VmOpenApiServiceLocationChannelIn.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v7VmOpenApiServiceLocationChannelIn.isVisibleForAll) &&
        Objects.equals(this.services, v7VmOpenApiServiceLocationChannelIn.services);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiServiceLocationChannelIn {\n");
