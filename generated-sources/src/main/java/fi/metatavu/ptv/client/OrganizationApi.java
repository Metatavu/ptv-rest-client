...
public class OrganizationApi {
   ...
   */
  public ApiResponse<List<V5VmOpenApiOrganization>> apiV5OrganizationBusinesscodeByCodeGet(String code) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v5/Organization/businesscode/{code}"
      .replaceAll("\\{" + "code" + "\\}", code);
      
    ResultType<List<V5VmOpenApiOrganization>> resultType = new ResultType<List<V5VmOpenApiOrganization>>() {};
   ...
   */
  public ApiResponse<V5VmOpenApiOrganization> apiV5OrganizationByIdGet(String id) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v5/Organization/{id}"
      .replaceAll("\\{" + "id" + "\\}", id);
      
    ResultType<V5VmOpenApiOrganization> resultType = new ResultType<V5VmOpenApiOrganization>() {};
    return client.doGETRequest(path, resultType, queryParams, formParams);
  }
  /**
   ...
   */
  public ApiResponse<V5VmOpenApiOrganization> apiV5OrganizationByIdPut(String id, V5VmOpenApiOrganizationInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   */
  public ApiResponse<V3VmOpenApiGuidPage> apiV5OrganizationGet(OffsetDateTime date, Integer page) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
    if (date != null)
...
if (page != null)
    ...
    String path = "/api/v5/Organization";
   ...
   */
  public ApiResponse<V5VmOpenApiOrganization> apiV5OrganizationOidByOidGet(String oid) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v5/Organization/oid/{oid}"
      .replaceAll("\\{" + "oid" + "\\}", oid);
   ...
   */
  public ApiResponse<V5VmOpenApiOrganization> apiV5OrganizationPost(V5VmOpenApiOrganizationIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   * @param request organization values (optional)
   */
  public ApiResponse<V5VmOpenApiOrganization> apiV5OrganizationSourceIdBySourceIdPut(String sourceId, V5VmOpenApiOrganizationInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v5/Organization/sourceId/{sourceId}"
