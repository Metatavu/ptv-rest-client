 ...
 */
@ApiModel(description = "OPEN API V8 - View Model of general description for IN api base (PUT)")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-08-06T13:25:17.639+03:00")
public class V8VmOpenApiGeneralDescriptionInBase {
  @JsonProperty("names")
  ...
  public V8VmOpenApiGeneralDescriptionInBase names(List<VmOpenApiLocalizedListItem> names) {
    this.names = names;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addNamesItem(VmOpenApiLocalizedListItem namesItem) {
    if (this.names == null) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase descriptions(List<VmOpenApiLocalizedListItem> descriptions) {
    this.descriptions = descriptions;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addDescriptionsItem(VmOpenApiLocalizedListItem descriptionsItem) {
   ...
   /**
   * List of localized descriptions. (Max.Length: 150 Summary). (Max.Length: 2500 Description). (Max.Length: 2500 UserInstruction). (Max.Length: 2500 BackgroundDescription).
   * @return descriptions
  **/
  @ApiModelProperty(value = "List of localized descriptions. (Max.Length: 150 Summary). (Max.Length: 2500 Description). (Max.Length: 2500 UserInstruction). (Max.Length: 2500 BackgroundDescription).")
  ...
  public V8VmOpenApiGeneralDescriptionInBase languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase serviceClasses(List<String> serviceClasses) {
    this.serviceClasses = serviceClasses;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addServiceClassesItem(String serviceClassesItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase ontologyTerms(List<String> ontologyTerms) {
    this.ontologyTerms = ontologyTerms;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addOntologyTermsItem(String ontologyTermsItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase targetGroups(List<String> targetGroups) {
    this.targetGroups = targetGroups;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addTargetGroupsItem(String targetGroupsItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase lifeEvents(List<String> lifeEvents) {
    this.lifeEvents = lifeEvents;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addLifeEventsItem(String lifeEventsItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase industrialClasses(List<String> industrialClasses) {
    this.industrialClasses = industrialClasses;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addIndustrialClassesItem(String industrialClassesItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase requirements(List<VmOpenApiLanguageItem> requirements) {
    this.requirements = requirements;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addRequirementsItem(VmOpenApiLanguageItem requirementsItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase legislation(List<V4VmOpenApiLaw> legislation) {
    this.legislation = legislation;
    return this;
  }

  public V8VmOpenApiGeneralDescriptionInBase addLegislationItem(V4VmOpenApiLaw legislationItem) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase generalDescriptionType(String generalDescriptionType) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase deleteAllLifeEvents(Boolean deleteAllLifeEvents) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase deleteAllIndustrialClasses(Boolean deleteAllIndustrialClasses) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase deleteAllLaws(Boolean deleteAllLaws) {
  ...
  **/
  ...
  public V8VmOpenApiGeneralDescriptionInBase deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiGeneralDescriptionInBase v8VmOpenApiGeneralDescriptionInBase = (V8VmOpenApiGeneralDescriptionInBase) o;
    return Objects.equals(this.names, v8VmOpenApiGeneralDescriptionInBase.names) &&
        Objects.equals(this.descriptions, v8VmOpenApiGeneralDescriptionInBase.descriptions) &&
        Objects.equals(this.languages, v8VmOpenApiGeneralDescriptionInBase.languages) &&
        Objects.equals(this.serviceClasses, v8VmOpenApiGeneralDescriptionInBase.serviceClasses) &&
        Objects.equals(this.ontologyTerms, v8VmOpenApiGeneralDescriptionInBase.ontologyTerms) &&
        Objects.equals(this.targetGroups, v8VmOpenApiGeneralDescriptionInBase.targetGroups) &&
        Objects.equals(this.lifeEvents, v8VmOpenApiGeneralDescriptionInBase.lifeEvents) &&
        Objects.equals(this.industrialClasses, v8VmOpenApiGeneralDescriptionInBase.industrialClasses) &&
        Objects.equals(this.requirements, v8VmOpenApiGeneralDescriptionInBase.requirements) &&
        Objects.equals(this.type, v8VmOpenApiGeneralDescriptionInBase.type) &&
        Objects.equals(this.serviceChargeType, v8VmOpenApiGeneralDescriptionInBase.serviceChargeType) &&
        Objects.equals(this.legislation, v8VmOpenApiGeneralDescriptionInBase.legislation) &&
        Objects.equals(this.generalDescriptionType, v8VmOpenApiGeneralDescriptionInBase.generalDescriptionType) &&
        Objects.equals(this.publishingStatus, v8VmOpenApiGeneralDescriptionInBase.publishingStatus) &&
        Objects.equals(this.deleteAllLifeEvents, v8VmOpenApiGeneralDescriptionInBase.deleteAllLifeEvents) &&
        Objects.equals(this.deleteAllIndustrialClasses, v8VmOpenApiGeneralDescriptionInBase.deleteAllIndustrialClasses) &&
        Objects.equals(this.deleteAllLaws, v8VmOpenApiGeneralDescriptionInBase.deleteAllLaws) &&
        Objects.equals(this.deleteServiceChargeType, v8VmOpenApiGeneralDescriptionInBase.deleteServiceChargeType);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiGeneralDescriptionInBase {\n");
