...
public class V5VmOpenApiPrintableFormChannel   {
  ...
  public V5VmOpenApiPrintableFormChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel areaType(String areaType) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel areas(List<VmOpenApiArea> areas) {
    this.areas = areas;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addAreasItem(VmOpenApiArea areasItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel formIdentifier(List<VmOpenApiLanguageItem> formIdentifier) {
    this.formIdentifier = formIdentifier;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addFormIdentifierItem(VmOpenApiLanguageItem formIdentifierItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel formReceiver(List<VmOpenApiLanguageItem> formReceiver) {
    this.formReceiver = formReceiver;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addFormReceiverItem(VmOpenApiLanguageItem formReceiverItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel deliveryAddress(V5VmOpenApiAddressWithCoordinates deliveryAddress) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel channelUrls(List<VmOpenApiLocalizedListItem> channelUrls) {
    this.channelUrls = channelUrls;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addChannelUrlsItem(VmOpenApiLocalizedListItem channelUrlsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel attachments(List<VmOpenApiAttachmentWithType> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addAttachmentsItem(VmOpenApiAttachmentWithType attachmentsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V5VmOpenApiPrintableFormChannel addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiPrintableFormChannel v5VmOpenApiPrintableFormChannel = (V5VmOpenApiPrintableFormChannel) o;
    return Objects.equals(this.id, v5VmOpenApiPrintableFormChannel.id) &&
        Objects.equals(this.serviceChannelType, v5VmOpenApiPrintableFormChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v5VmOpenApiPrintableFormChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v5VmOpenApiPrintableFormChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v5VmOpenApiPrintableFormChannel.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v5VmOpenApiPrintableFormChannel.areaType) &&
        Objects.equals(this.areas, v5VmOpenApiPrintableFormChannel.areas) &&
        Objects.equals(this.formIdentifier, v5VmOpenApiPrintableFormChannel.formIdentifier) &&
        Objects.equals(this.formReceiver, v5VmOpenApiPrintableFormChannel.formReceiver) &&
        Objects.equals(this.deliveryAddress, v5VmOpenApiPrintableFormChannel.deliveryAddress) &&
        Objects.equals(this.channelUrls, v5VmOpenApiPrintableFormChannel.channelUrls) &&
        Objects.equals(this.attachments, v5VmOpenApiPrintableFormChannel.attachments) &&
        Objects.equals(this.supportPhones, v5VmOpenApiPrintableFormChannel.supportPhones) &&
        Objects.equals(this.supportEmails, v5VmOpenApiPrintableFormChannel.supportEmails) &&
        Objects.equals(this.languages, v5VmOpenApiPrintableFormChannel.languages) &&
        Objects.equals(this.webPages, v5VmOpenApiPrintableFormChannel.webPages) &&
        Objects.equals(this.serviceHours, v5VmOpenApiPrintableFormChannel.serviceHours) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiPrintableFormChannel.publishingStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, serviceChannelType, organizationId, serviceChannelNames, serviceChannelDescriptions, areaType, areas, formIdentifier, formReceiver, deliveryAddress, channelUrls, attachments, supportPhones, supportEmails, languages, webPages, serviceHours, publishingStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiPrintableFormChannel {\n");
