...
import fi.metatavu.ptv.client.model.V9VmOpenApiServiceServiceChannelAstiInBase;
...
public class V9VmOpenApiServiceAndChannelRelationAstiInBase {
  @JsonProperty("deleteAllChannelRelations")
  private Boolean deleteAllChannelRelations = null;

  @JsonProperty("channelRelations")
  private List<V9VmOpenApiServiceServiceChannelAstiInBase> channelRelations = null;

  public V9VmOpenApiServiceAndChannelRelationAstiInBase deleteAllChannelRelations(Boolean deleteAllChannelRelations) {
  ...
  **/
  ...
  public V9VmOpenApiServiceAndChannelRelationAstiInBase channelRelations(List<V9VmOpenApiServiceServiceChannelAstiInBase> channelRelations) {
    this.channelRelations = channelRelations;
    return this;
  }

  public V9VmOpenApiServiceAndChannelRelationAstiInBase addChannelRelationsItem(V9VmOpenApiServiceServiceChannelAstiInBase channelRelationsItem) {
    if (this.channelRelations == null) {
      this.channelRelations = new ArrayList<V9VmOpenApiServiceServiceChannelAstiInBase>();
    }
  ...
  **/
  ...
  public List<V9VmOpenApiServiceServiceChannelAstiInBase> getChannelRelations() {
    return channelRelations;
  }

  public void setChannelRelations(List<V9VmOpenApiServiceServiceChannelAstiInBase> channelRelations) {
    this.channelRelations = channelRelations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V9VmOpenApiServiceAndChannelRelationAstiInBase v9VmOpenApiServiceAndChannelRelationAstiInBase = (V9VmOpenApiServiceAndChannelRelationAstiInBase) o;
    return Objects.equals(this.deleteAllChannelRelations, v9VmOpenApiServiceAndChannelRelationAstiInBase.deleteAllChannelRelations) &&
        Objects.equals(this.channelRelations, v9VmOpenApiServiceAndChannelRelationAstiInBase.channelRelations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V9VmOpenApiServiceAndChannelRelationAstiInBase {\n");
