...
public class V5VmOpenApiOrganizationInBase   {
  ...
  **/
   ...
   * @return oid
  **/
  @ApiModelProperty(example = "null", value = "Organization OID. - must match the regex @\"^[A-Za-z0-9.-]*$\" (Max.Length: 100).")
  ...
  **/
  ...
  public V5VmOpenApiOrganizationInBase addOrganizationDescriptionsItem(VmOpenApiLanguageItem organizationDescriptionsItem) {
   ...
   /**
   * Localized list of organization descriptions. (Max.Length: 500).
   * @return organizationDescriptions
  **/
  @ApiModelProperty(example = "null", value = "Localized list of organization descriptions. (Max.Length: 500).")
  ...
  **/
   ...
   * @return subAreaType
  **/
  @ApiModelProperty(example = "null", value = "Sub area type (Municipality, Province, BusinessRegions, HospitalRegions).")
   ...
   * @return areas
  **/
  @ApiModelProperty(example = "null", value = "Area codes related to sub area type. For example if SubAreaType = Municipality, Areas-list need to include municipality codes like 491 or 091.")
