...
public class V7VmOpenApiPrintableFormChannel {
  ...
  private V7VmOpenApiAddressDelivery deliveryAddress = null;
  ...
  public V7VmOpenApiPrintableFormChannel id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel sourceId(String sourceId) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel organizationId(UUID organizationId) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel areaType(String areaType) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel areas(List<VmOpenApiArea> areas) {
    this.areas = areas;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addAreasItem(VmOpenApiArea areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel formIdentifier(List<VmOpenApiLanguageItem> formIdentifier) {
    this.formIdentifier = formIdentifier;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addFormIdentifierItem(VmOpenApiLanguageItem formIdentifierItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel formReceiver(List<VmOpenApiLanguageItem> formReceiver) {
    this.formReceiver = formReceiver;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addFormReceiverItem(VmOpenApiLanguageItem formReceiverItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel deliveryAddress(V7VmOpenApiAddressDelivery deliveryAddress) {
  ...
  **/
  ...
  public V7VmOpenApiAddressDelivery getDeliveryAddress() {
    return deliveryAddress;
  }

  public void setDeliveryAddress(V7VmOpenApiAddressDelivery deliveryAddress) {
    this.deliveryAddress = deliveryAddress;
  }

  public V7VmOpenApiPrintableFormChannel channelUrls(List<VmOpenApiLocalizedListItem> channelUrls) {
    this.channelUrls = channelUrls;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addChannelUrlsItem(VmOpenApiLocalizedListItem channelUrlsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel attachments(List<VmOpenApiAttachmentWithType> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addAttachmentsItem(VmOpenApiAttachmentWithType attachmentsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel services(List<VmOpenApiServiceChannelService> services) {
    this.services = services;
    return this;
  }

  public V7VmOpenApiPrintableFormChannel addServicesItem(VmOpenApiServiceChannelService servicesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPrintableFormChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiPrintableFormChannel v7VmOpenApiPrintableFormChannel = (V7VmOpenApiPrintableFormChannel) o;
    return Objects.equals(this.id, v7VmOpenApiPrintableFormChannel.id) &&
        Objects.equals(this.sourceId, v7VmOpenApiPrintableFormChannel.sourceId) &&
        Objects.equals(this.serviceChannelType, v7VmOpenApiPrintableFormChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v7VmOpenApiPrintableFormChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v7VmOpenApiPrintableFormChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v7VmOpenApiPrintableFormChannel.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v7VmOpenApiPrintableFormChannel.areaType) &&
        Objects.equals(this.areas, v7VmOpenApiPrintableFormChannel.areas) &&
        Objects.equals(this.formIdentifier, v7VmOpenApiPrintableFormChannel.formIdentifier) &&
        Objects.equals(this.formReceiver, v7VmOpenApiPrintableFormChannel.formReceiver) &&
        Objects.equals(this.deliveryAddress, v7VmOpenApiPrintableFormChannel.deliveryAddress) &&
        Objects.equals(this.channelUrls, v7VmOpenApiPrintableFormChannel.channelUrls) &&
        Objects.equals(this.attachments, v7VmOpenApiPrintableFormChannel.attachments) &&
        Objects.equals(this.supportPhones, v7VmOpenApiPrintableFormChannel.supportPhones) &&
        Objects.equals(this.supportEmails, v7VmOpenApiPrintableFormChannel.supportEmails) &&
        Objects.equals(this.languages, v7VmOpenApiPrintableFormChannel.languages) &&
        Objects.equals(this.webPages, v7VmOpenApiPrintableFormChannel.webPages) &&
        Objects.equals(this.serviceHours, v7VmOpenApiPrintableFormChannel.serviceHours) &&
        Objects.equals(this.services, v7VmOpenApiPrintableFormChannel.services) &&
        Objects.equals(this.publishingStatus, v7VmOpenApiPrintableFormChannel.publishingStatus) &&
        Objects.equals(this.modified, v7VmOpenApiPrintableFormChannel.modified);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, sourceId, serviceChannelType, organizationId, serviceChannelNames, serviceChannelDescriptions, areaType, areas, formIdentifier, formReceiver, deliveryAddress, channelUrls, attachments, supportPhones, supportEmails, languages, webPages, serviceHours, services, publishingStatus, modified);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiPrintableFormChannel {\n");
