...
public class V9VmOpenApiOrganizationIn {
  ...
  **/
  @ApiModelProperty(required = true, value = "List of organization names. Possible type values are: Name, AlternativeName.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Localized list of organization descriptions. Possible type values are: Description, Summary.")
