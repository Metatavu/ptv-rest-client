...
public class V7VmOpenApiGeneralDescription {
  ...
  public V7VmOpenApiGeneralDescription id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription names(List<VmOpenApiLocalizedListItem> names) {
    this.names = names;
    return this;
  }

  public V7VmOpenApiGeneralDescription addNamesItem(VmOpenApiLocalizedListItem namesItem) {
    if (this.names == null) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription descriptions(List<VmOpenApiLocalizedListItem> descriptions) {
    this.descriptions = descriptions;
    return this;
  }

  public V7VmOpenApiGeneralDescription addDescriptionsItem(VmOpenApiLocalizedListItem descriptionsItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V7VmOpenApiGeneralDescription addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription serviceClasses(List<V7VmOpenApiFintoItemWithDescription> serviceClasses) {
    this.serviceClasses = serviceClasses;
    return this;
  }

  public V7VmOpenApiGeneralDescription addServiceClassesItem(V7VmOpenApiFintoItemWithDescription serviceClassesItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription ontologyTerms(List<V4VmOpenApiFintoItem> ontologyTerms) {
    this.ontologyTerms = ontologyTerms;
    return this;
  }

  public V7VmOpenApiGeneralDescription addOntologyTermsItem(V4VmOpenApiFintoItem ontologyTermsItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription targetGroups(List<V4VmOpenApiFintoItem> targetGroups) {
    this.targetGroups = targetGroups;
    return this;
  }

  public V7VmOpenApiGeneralDescription addTargetGroupsItem(V4VmOpenApiFintoItem targetGroupsItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription lifeEvents(List<V4VmOpenApiFintoItem> lifeEvents) {
    this.lifeEvents = lifeEvents;
    return this;
  }

  public V7VmOpenApiGeneralDescription addLifeEventsItem(V4VmOpenApiFintoItem lifeEventsItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription industrialClasses(List<V4VmOpenApiFintoItem> industrialClasses) {
    this.industrialClasses = industrialClasses;
    return this;
  }

  public V7VmOpenApiGeneralDescription addIndustrialClassesItem(V4VmOpenApiFintoItem industrialClassesItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription requirements(List<VmOpenApiLanguageItem> requirements) {
    this.requirements = requirements;
    return this;
  }

  public V7VmOpenApiGeneralDescription addRequirementsItem(VmOpenApiLanguageItem requirementsItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription legislation(List<V4VmOpenApiLaw> legislation) {
    this.legislation = legislation;
    return this;
  }

  public V7VmOpenApiGeneralDescription addLegislationItem(V4VmOpenApiLaw legislationItem) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V7VmOpenApiGeneralDescription serviceChannels(List<V6VmOpenApiServiceServiceChannel> serviceChannels) {
    this.serviceChannels = serviceChannels;
    return this;
  }

  public V7VmOpenApiGeneralDescription addServiceChannelsItem(V6VmOpenApiServiceServiceChannel serviceChannelsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiGeneralDescription v7VmOpenApiGeneralDescription = (V7VmOpenApiGeneralDescription) o;
    return Objects.equals(this.id, v7VmOpenApiGeneralDescription.id) &&
        Objects.equals(this.names, v7VmOpenApiGeneralDescription.names) &&
        Objects.equals(this.descriptions, v7VmOpenApiGeneralDescription.descriptions) &&
        Objects.equals(this.languages, v7VmOpenApiGeneralDescription.languages) &&
        Objects.equals(this.serviceClasses, v7VmOpenApiGeneralDescription.serviceClasses) &&
        Objects.equals(this.ontologyTerms, v7VmOpenApiGeneralDescription.ontologyTerms) &&
        Objects.equals(this.targetGroups, v7VmOpenApiGeneralDescription.targetGroups) &&
        Objects.equals(this.lifeEvents, v7VmOpenApiGeneralDescription.lifeEvents) &&
        Objects.equals(this.industrialClasses, v7VmOpenApiGeneralDescription.industrialClasses) &&
        Objects.equals(this.requirements, v7VmOpenApiGeneralDescription.requirements) &&
        Objects.equals(this.type, v7VmOpenApiGeneralDescription.type) &&
        Objects.equals(this.serviceChargeType, v7VmOpenApiGeneralDescription.serviceChargeType) &&
        Objects.equals(this.legislation, v7VmOpenApiGeneralDescription.legislation) &&
        Objects.equals(this.publishingStatus, v7VmOpenApiGeneralDescription.publishingStatus) &&
        Objects.equals(this.modified, v7VmOpenApiGeneralDescription.modified) &&
        Objects.equals(this.serviceChannels, v7VmOpenApiGeneralDescription.serviceChannels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, names, descriptions, languages, serviceClasses, ontologyTerms, targetGroups, lifeEvents, industrialClasses, requirements, type, serviceChargeType, legislation, publishingStatus, modified, serviceChannels);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiGeneralDescription {\n");
