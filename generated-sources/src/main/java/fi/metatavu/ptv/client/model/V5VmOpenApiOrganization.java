...
public class V5VmOpenApiOrganization   {
  ...
  public V5VmOpenApiOrganization id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V5VmOpenApiOrganization oid(String oid) {
    this.oid = oid;
    return this;
  }
  ...
  **/
  ...
  public V5VmOpenApiOrganization parentOrganization(String parentOrganization) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization organizationType(String organizationType) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization municipality(VmOpenApiMunicipality municipality) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization businessCode(String businessCode) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization businessName(String businessName) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization organizationNames(List<VmOpenApiLocalizedListItem> organizationNames) {
    this.organizationNames = organizationNames;
    return this;
  }

  public V5VmOpenApiOrganization addOrganizationNamesItem(VmOpenApiLocalizedListItem organizationNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization displayNameType(List<VmOpenApiNameTypeByLanguage> displayNameType) {
    this.displayNameType = displayNameType;
    return this;
  }

  public V5VmOpenApiOrganization addDisplayNameTypeItem(VmOpenApiNameTypeByLanguage displayNameTypeItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization areaType(String areaType) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization areas(List<VmOpenApiArea> areas) {
    this.areas = areas;
    return this;
  }

  public V5VmOpenApiOrganization addAreasItem(VmOpenApiArea areasItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization organizationDescriptions(List<VmOpenApiLocalizedListItem> organizationDescriptions) {
    this.organizationDescriptions = organizationDescriptions;
    return this;
  }

  public V5VmOpenApiOrganization addOrganizationDescriptionsItem(VmOpenApiLocalizedListItem organizationDescriptionsItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization emailAddresses(List<V4VmOpenApiEmail> emailAddresses) {
    this.emailAddresses = emailAddresses;
    return this;
  }

  public V5VmOpenApiOrganization addEmailAddressesItem(V4VmOpenApiEmail emailAddressesItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization phoneNumbers(List<V4VmOpenApiPhone> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V5VmOpenApiOrganization addPhoneNumbersItem(V4VmOpenApiPhone phoneNumbersItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V5VmOpenApiOrganization addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization addresses(List<V5VmOpenApiAddressWithTypeAndCoordinates> addresses) {
    this.addresses = addresses;
    return this;
  }

  public V5VmOpenApiOrganization addAddressesItem(V5VmOpenApiAddressWithTypeAndCoordinates addressesItem) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V5VmOpenApiOrganization services(List<V5VmOpenApiOrganizationService> services) {
    this.services = services;
    return this;
  }

  public V5VmOpenApiOrganization addServicesItem(V5VmOpenApiOrganizationService servicesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiOrganization v5VmOpenApiOrganization = (V5VmOpenApiOrganization) o;
    return Objects.equals(this.id, v5VmOpenApiOrganization.id) &&
        Objects.equals(this.oid, v5VmOpenApiOrganization.oid) &&
        Objects.equals(this.parentOrganization, v5VmOpenApiOrganization.parentOrganization) &&
        Objects.equals(this.organizationType, v5VmOpenApiOrganization.organizationType) &&
        Objects.equals(this.municipality, v5VmOpenApiOrganization.municipality) &&
        Objects.equals(this.businessCode, v5VmOpenApiOrganization.businessCode) &&
        Objects.equals(this.businessName, v5VmOpenApiOrganization.businessName) &&
        Objects.equals(this.organizationNames, v5VmOpenApiOrganization.organizationNames) &&
        Objects.equals(this.displayNameType, v5VmOpenApiOrganization.displayNameType) &&
        Objects.equals(this.areaType, v5VmOpenApiOrganization.areaType) &&
        Objects.equals(this.areas, v5VmOpenApiOrganization.areas) &&
        Objects.equals(this.organizationDescriptions, v5VmOpenApiOrganization.organizationDescriptions) &&
        Objects.equals(this.emailAddresses, v5VmOpenApiOrganization.emailAddresses) &&
        Objects.equals(this.phoneNumbers, v5VmOpenApiOrganization.phoneNumbers) &&
        Objects.equals(this.webPages, v5VmOpenApiOrganization.webPages) &&
        Objects.equals(this.addresses, v5VmOpenApiOrganization.addresses) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiOrganization.publishingStatus) &&
        Objects.equals(this.services, v5VmOpenApiOrganization.services);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, oid, parentOrganization, organizationType, municipality, businessCode, businessName, organizationNames, displayNameType, areaType, areas, organizationDescriptions, emailAddresses, phoneNumbers, webPages, addresses, publishingStatus, services);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiOrganization {\n");
