...
public class V5VmOpenApiPhoneChannelInBase   {
  ...
  public V5VmOpenApiPhoneChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase areaType(String areaType) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addAreasItem(VmOpenApiAreaIn areasItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase phoneNumbers(List<V5VmOpenApiPhoneChannelPhone> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addPhoneNumbersItem(V5VmOpenApiPhoneChannelPhone phoneNumbersItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V5VmOpenApiPhoneChannelInBase addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase deleteAllWebPages(Boolean deleteAllWebPages) {
  ...
  **/
  ...
  public V5VmOpenApiPhoneChannelInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiPhoneChannelInBase v5VmOpenApiPhoneChannelInBase = (V5VmOpenApiPhoneChannelInBase) o;
    return Objects.equals(this.sourceId, v5VmOpenApiPhoneChannelInBase.sourceId) &&
        Objects.equals(this.organizationId, v5VmOpenApiPhoneChannelInBase.organizationId) &&
        Objects.equals(this.serviceChannelDescriptions, v5VmOpenApiPhoneChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.serviceChannelNames, v5VmOpenApiPhoneChannelInBase.serviceChannelNames) &&
        Objects.equals(this.areaType, v5VmOpenApiPhoneChannelInBase.areaType) &&
        Objects.equals(this.areas, v5VmOpenApiPhoneChannelInBase.areas) &&
        Objects.equals(this.phoneNumbers, v5VmOpenApiPhoneChannelInBase.phoneNumbers) &&
        Objects.equals(this.urls, v5VmOpenApiPhoneChannelInBase.urls) &&
        Objects.equals(this.supportEmails, v5VmOpenApiPhoneChannelInBase.supportEmails) &&
        Objects.equals(this.languages, v5VmOpenApiPhoneChannelInBase.languages) &&
        Objects.equals(this.serviceHours, v5VmOpenApiPhoneChannelInBase.serviceHours) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiPhoneChannelInBase.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v5VmOpenApiPhoneChannelInBase.isVisibleForAll) &&
        Objects.equals(this.deleteAllWebPages, v5VmOpenApiPhoneChannelInBase.deleteAllWebPages) &&
        Objects.equals(this.deleteAllServiceHours, v5VmOpenApiPhoneChannelInBase.deleteAllServiceHours);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelDescriptions, serviceChannelNames, areaType, areas, phoneNumbers, urls, supportEmails, languages, serviceHours, publishingStatus, isVisibleForAll, deleteAllWebPages, deleteAllServiceHours);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiPhoneChannelInBase {\n");
