...
public class V8VmOpenApiServiceAndChannelRelationBySource {
  ...
  public V8VmOpenApiServiceAndChannelRelationBySource serviceSourceId(String serviceSourceId) {
  ...
  **/
  ...
  public V8VmOpenApiServiceAndChannelRelationBySource serviceChannelSourceId(String serviceChannelSourceId) {
  ...
  **/
  ...
  public V8VmOpenApiServiceAndChannelRelationBySource description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V8VmOpenApiServiceAndChannelRelationBySource addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceAndChannelRelationBySource serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V8VmOpenApiServiceAndChannelRelationBySource serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V8VmOpenApiServiceAndChannelRelationBySource addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceAndChannelRelationBySource contactDetails(V8VmOpenApiContactDetailsIn contactDetails) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiServiceAndChannelRelationBySource v8VmOpenApiServiceAndChannelRelationBySource = (V8VmOpenApiServiceAndChannelRelationBySource) o;
    return Objects.equals(this.serviceSourceId, v8VmOpenApiServiceAndChannelRelationBySource.serviceSourceId) &&
        Objects.equals(this.serviceChannelSourceId, v8VmOpenApiServiceAndChannelRelationBySource.serviceChannelSourceId) &&
        Objects.equals(this.description, v8VmOpenApiServiceAndChannelRelationBySource.description) &&
        Objects.equals(this.serviceChargeType, v8VmOpenApiServiceAndChannelRelationBySource.serviceChargeType) &&
        Objects.equals(this.serviceHours, v8VmOpenApiServiceAndChannelRelationBySource.serviceHours) &&
        Objects.equals(this.contactDetails, v8VmOpenApiServiceAndChannelRelationBySource.contactDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiServiceAndChannelRelationBySource {\n");
