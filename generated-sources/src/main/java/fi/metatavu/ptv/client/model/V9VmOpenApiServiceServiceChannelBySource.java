...
public class V9VmOpenApiServiceServiceChannelBySource {
  ...
  public V9VmOpenApiServiceServiceChannelBySource serviceChannelSourceId(String serviceChannelSourceId) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V9VmOpenApiServiceServiceChannelBySource addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V9VmOpenApiServiceServiceChannelBySource addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource contactDetails(V9VmOpenApiContactDetailsInBase contactDetails) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource deleteAllDescriptions(Boolean deleteAllDescriptions) {
  ...
  **/
  ...
  public V9VmOpenApiServiceServiceChannelBySource deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V9VmOpenApiServiceServiceChannelBySource v9VmOpenApiServiceServiceChannelBySource = (V9VmOpenApiServiceServiceChannelBySource) o;
    return Objects.equals(this.serviceChannelSourceId, v9VmOpenApiServiceServiceChannelBySource.serviceChannelSourceId) &&
        Objects.equals(this.description, v9VmOpenApiServiceServiceChannelBySource.description) &&
        Objects.equals(this.serviceChargeType, v9VmOpenApiServiceServiceChannelBySource.serviceChargeType) &&
        Objects.equals(this.serviceHours, v9VmOpenApiServiceServiceChannelBySource.serviceHours) &&
        Objects.equals(this.contactDetails, v9VmOpenApiServiceServiceChannelBySource.contactDetails) &&
        Objects.equals(this.deleteServiceChargeType, v9VmOpenApiServiceServiceChannelBySource.deleteServiceChargeType) &&
        Objects.equals(this.deleteAllDescriptions, v9VmOpenApiServiceServiceChannelBySource.deleteAllDescriptions) &&
        Objects.equals(this.deleteAllServiceHours, v9VmOpenApiServiceServiceChannelBySource.deleteAllServiceHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class V9VmOpenApiServiceServiceChannelBySource {\n");
