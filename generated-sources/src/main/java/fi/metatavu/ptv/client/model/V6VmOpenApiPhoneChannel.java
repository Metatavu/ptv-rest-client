...
public class V6VmOpenApiPhoneChannel   {
  ...
  public V6VmOpenApiPhoneChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V6VmOpenApiPhoneChannel organizationId(String organizationId) {
  ...
  **/
  ...
  public V6VmOpenApiPhoneChannel modified(OffsetDateTime modified) {
