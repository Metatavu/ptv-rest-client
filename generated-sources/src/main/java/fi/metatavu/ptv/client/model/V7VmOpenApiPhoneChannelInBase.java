 ...
 */
@ApiModel(description = "OPEN API V7 - View Model of phone channel for IN api - base")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-10-23T08:36:23.831+03:00")
public class V7VmOpenApiPhoneChannelInBase {
  ...
  public V7VmOpenApiPhoneChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase areaType(String areaType) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addAreasItem(VmOpenApiAreaIn areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase phoneNumbers(List<V4VmOpenApiPhoneWithType> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addPhoneNumbersItem(V4VmOpenApiPhoneWithType phoneNumbersItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addUrlsItem(VmOpenApiLanguageItem urlsItem) {
    if (this.urls == null) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V7VmOpenApiPhoneChannelInBase addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase deleteAllWebPages(Boolean deleteAllWebPages) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannelInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiPhoneChannelInBase v7VmOpenApiPhoneChannelInBase = (V7VmOpenApiPhoneChannelInBase) o;
    return Objects.equals(this.sourceId, v7VmOpenApiPhoneChannelInBase.sourceId) &&
        Objects.equals(this.organizationId, v7VmOpenApiPhoneChannelInBase.organizationId) &&
        Objects.equals(this.serviceChannelNames, v7VmOpenApiPhoneChannelInBase.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v7VmOpenApiPhoneChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v7VmOpenApiPhoneChannelInBase.areaType) &&
        Objects.equals(this.areas, v7VmOpenApiPhoneChannelInBase.areas) &&
        Objects.equals(this.phoneNumbers, v7VmOpenApiPhoneChannelInBase.phoneNumbers) &&
        Objects.equals(this.urls, v7VmOpenApiPhoneChannelInBase.urls) &&
        Objects.equals(this.supportEmails, v7VmOpenApiPhoneChannelInBase.supportEmails) &&
        Objects.equals(this.languages, v7VmOpenApiPhoneChannelInBase.languages) &&
        Objects.equals(this.serviceHours, v7VmOpenApiPhoneChannelInBase.serviceHours) &&
        Objects.equals(this.publishingStatus, v7VmOpenApiPhoneChannelInBase.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v7VmOpenApiPhoneChannelInBase.isVisibleForAll) &&
        Objects.equals(this.deleteAllWebPages, v7VmOpenApiPhoneChannelInBase.deleteAllWebPages) &&
        Objects.equals(this.deleteAllServiceHours, v7VmOpenApiPhoneChannelInBase.deleteAllServiceHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiPhoneChannelInBase {\n");
