...
public class V7VmOpenApiOrganizationIn {
  ...
  public V7VmOpenApiOrganizationIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn oid(String oid) {
    this.oid = oid;
    return this;
  }
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn municipality(String municipality) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn organizationType(String organizationType) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn businessCode(String businessCode) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn businessName(String businessName) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn organizationNames(List<VmOpenApiLocalizedListItem> organizationNames) {
    this.organizationNames = organizationNames;
    return this;
  }

  public V7VmOpenApiOrganizationIn addOrganizationNamesItem(VmOpenApiLocalizedListItem organizationNamesItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn displayNameType(List<VmOpenApiNameTypeByLanguage> displayNameType) {
    this.displayNameType = displayNameType;
    return this;
  }

  public V7VmOpenApiOrganizationIn addDisplayNameTypeItem(VmOpenApiNameTypeByLanguage displayNameTypeItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn areaType(String areaType) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn subAreaType(String subAreaType) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn areas(List<String> areas) {
    this.areas = areas;
    return this;
  }

  public V7VmOpenApiOrganizationIn addAreasItem(String areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn organizationDescriptions(List<VmOpenApiLocalizedListItem> organizationDescriptions) {
    this.organizationDescriptions = organizationDescriptions;
    return this;
  }

  public V7VmOpenApiOrganizationIn addOrganizationDescriptionsItem(VmOpenApiLocalizedListItem organizationDescriptionsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Localized list of organization descriptions. (Max.Length: 2500 Description). (Max.Length: 150 ShortDescription).")
  ...
  public V7VmOpenApiOrganizationIn emailAddresses(List<V4VmOpenApiEmail> emailAddresses) {
    this.emailAddresses = emailAddresses;
    return this;
  }

  public V7VmOpenApiOrganizationIn addEmailAddressesItem(V4VmOpenApiEmail emailAddressesItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn phoneNumbers(List<V4VmOpenApiPhone> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V7VmOpenApiOrganizationIn addPhoneNumbersItem(V4VmOpenApiPhone phoneNumbersItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V7VmOpenApiOrganizationIn addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn addresses(List<V7VmOpenApiAddressWithForeignIn> addresses) {
    this.addresses = addresses;
    return this;
  }

  public V7VmOpenApiOrganizationIn addAddressesItem(V7VmOpenApiAddressWithForeignIn addressesItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn electronicInvoicings(List<VmOpenApiOrganizationEInvoicing> electronicInvoicings) {
    this.electronicInvoicings = electronicInvoicings;
    return this;
  }

  public V7VmOpenApiOrganizationIn addElectronicInvoicingsItem(VmOpenApiOrganizationEInvoicing electronicInvoicingsItem) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V7VmOpenApiOrganizationIn parentOrganizationId(String parentOrganizationId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiOrganizationIn v7VmOpenApiOrganizationIn = (V7VmOpenApiOrganizationIn) o;
    return Objects.equals(this.sourceId, v7VmOpenApiOrganizationIn.sourceId) &&
        Objects.equals(this.oid, v7VmOpenApiOrganizationIn.oid) &&
        Objects.equals(this.municipality, v7VmOpenApiOrganizationIn.municipality) &&
        Objects.equals(this.organizationType, v7VmOpenApiOrganizationIn.organizationType) &&
        Objects.equals(this.businessCode, v7VmOpenApiOrganizationIn.businessCode) &&
        Objects.equals(this.businessName, v7VmOpenApiOrganizationIn.businessName) &&
        Objects.equals(this.organizationNames, v7VmOpenApiOrganizationIn.organizationNames) &&
        Objects.equals(this.displayNameType, v7VmOpenApiOrganizationIn.displayNameType) &&
        Objects.equals(this.areaType, v7VmOpenApiOrganizationIn.areaType) &&
        Objects.equals(this.subAreaType, v7VmOpenApiOrganizationIn.subAreaType) &&
        Objects.equals(this.areas, v7VmOpenApiOrganizationIn.areas) &&
        Objects.equals(this.organizationDescriptions, v7VmOpenApiOrganizationIn.organizationDescriptions) &&
        Objects.equals(this.emailAddresses, v7VmOpenApiOrganizationIn.emailAddresses) &&
        Objects.equals(this.phoneNumbers, v7VmOpenApiOrganizationIn.phoneNumbers) &&
        Objects.equals(this.webPages, v7VmOpenApiOrganizationIn.webPages) &&
        Objects.equals(this.addresses, v7VmOpenApiOrganizationIn.addresses) &&
        Objects.equals(this.electronicInvoicings, v7VmOpenApiOrganizationIn.electronicInvoicings) &&
        Objects.equals(this.publishingStatus, v7VmOpenApiOrganizationIn.publishingStatus) &&
        Objects.equals(this.parentOrganizationId, v7VmOpenApiOrganizationIn.parentOrganizationId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, oid, municipality, organizationType, businessCode, businessName, organizationNames, displayNameType, areaType, subAreaType, areas, organizationDescriptions, emailAddresses, phoneNumbers, webPages, addresses, electronicInvoicings, publishingStatus, parentOrganizationId);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiOrganizationIn {\n");
