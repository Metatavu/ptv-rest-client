...
public class V5VmOpenApiOrganizationIn   {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of organization names. (Max.Length: 100).")
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of Display name types (Name or AlternateName) for each language version of OrganizationNames.")
