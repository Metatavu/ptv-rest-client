...
public class V8VmOpenApiServiceAndChannelRelationInBase {
  @JsonProperty("deleteAllChannelRelations")
  private Boolean deleteAllChannelRelations = null;

  @JsonProperty("channelRelations")
  private List<V8VmOpenApiServiceServiceChannelInBase> channelRelations = null;

  public V8VmOpenApiServiceAndChannelRelationInBase deleteAllChannelRelations(Boolean deleteAllChannelRelations) {
  ...
  **/
  ...
  public V8VmOpenApiServiceAndChannelRelationInBase channelRelations(List<V8VmOpenApiServiceServiceChannelInBase> channelRelations) {
    this.channelRelations = channelRelations;
    return this;
  }

  public V8VmOpenApiServiceAndChannelRelationInBase addChannelRelationsItem(V8VmOpenApiServiceServiceChannelInBase channelRelationsItem) {
    if (this.channelRelations == null) {
      this.channelRelations = new ArrayList<V8VmOpenApiServiceServiceChannelInBase>();
    }
  ...
  **/
  ...
  public List<V8VmOpenApiServiceServiceChannelInBase> getChannelRelations() {
    return channelRelations;
  }

  public void setChannelRelations(List<V8VmOpenApiServiceServiceChannelInBase> channelRelations) {
    this.channelRelations = channelRelations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiServiceAndChannelRelationInBase v8VmOpenApiServiceAndChannelRelationInBase = (V8VmOpenApiServiceAndChannelRelationInBase) o;
    return Objects.equals(this.deleteAllChannelRelations, v8VmOpenApiServiceAndChannelRelationInBase.deleteAllChannelRelations) &&
        Objects.equals(this.channelRelations, v8VmOpenApiServiceAndChannelRelationInBase.channelRelations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiServiceAndChannelRelationInBase {\n");
