...
public class V7VmOpenApiPhoneChannel {
  ...
  public V7VmOpenApiPhoneChannel id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel sourceId(String sourceId) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel serviceChannelType(String serviceChannelType) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel organizationId(UUID organizationId) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel serviceChannelNames(List<VmOpenApiLocalizedListItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V7VmOpenApiPhoneChannel addServiceChannelNamesItem(VmOpenApiLocalizedListItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V7VmOpenApiPhoneChannel addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel areaType(String areaType) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel areas(List<VmOpenApiArea> areas) {
    this.areas = areas;
    return this;
  }

  public V7VmOpenApiPhoneChannel addAreasItem(VmOpenApiArea areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel phoneNumbers(List<V4VmOpenApiPhoneWithType> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V7VmOpenApiPhoneChannel addPhoneNumbersItem(V4VmOpenApiPhoneWithType phoneNumbersItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V7VmOpenApiPhoneChannel addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V7VmOpenApiPhoneChannel addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V7VmOpenApiPhoneChannel addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V7VmOpenApiPhoneChannel addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel services(List<VmOpenApiServiceChannelService> services) {
    this.services = services;
    return this;
  }

  public V7VmOpenApiPhoneChannel addServicesItem(VmOpenApiServiceChannelService servicesItem) {
  ...
  **/
  ...
  public V7VmOpenApiPhoneChannel publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiPhoneChannel v7VmOpenApiPhoneChannel = (V7VmOpenApiPhoneChannel) o;
    return Objects.equals(this.id, v7VmOpenApiPhoneChannel.id) &&
        Objects.equals(this.sourceId, v7VmOpenApiPhoneChannel.sourceId) &&
        Objects.equals(this.serviceChannelType, v7VmOpenApiPhoneChannel.serviceChannelType) &&
        Objects.equals(this.organizationId, v7VmOpenApiPhoneChannel.organizationId) &&
        Objects.equals(this.serviceChannelNames, v7VmOpenApiPhoneChannel.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v7VmOpenApiPhoneChannel.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v7VmOpenApiPhoneChannel.areaType) &&
        Objects.equals(this.areas, v7VmOpenApiPhoneChannel.areas) &&
        Objects.equals(this.phoneNumbers, v7VmOpenApiPhoneChannel.phoneNumbers) &&
        Objects.equals(this.supportEmails, v7VmOpenApiPhoneChannel.supportEmails) &&
        Objects.equals(this.languages, v7VmOpenApiPhoneChannel.languages) &&
        Objects.equals(this.webPages, v7VmOpenApiPhoneChannel.webPages) &&
        Objects.equals(this.serviceHours, v7VmOpenApiPhoneChannel.serviceHours) &&
        Objects.equals(this.services, v7VmOpenApiPhoneChannel.services) &&
        Objects.equals(this.publishingStatus, v7VmOpenApiPhoneChannel.publishingStatus) &&
        Objects.equals(this.modified, v7VmOpenApiPhoneChannel.modified);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiPhoneChannel {\n");
