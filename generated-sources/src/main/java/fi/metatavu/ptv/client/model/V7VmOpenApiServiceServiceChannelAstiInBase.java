...
public class V7VmOpenApiServiceServiceChannelAstiInBase {
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase serviceChannelId(String serviceChannelId) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V7VmOpenApiServiceServiceChannelAstiInBase addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase extraTypes(List<VmOpenApiExtraType> extraTypes) {
    this.extraTypes = extraTypes;
    return this;
  }

  public V7VmOpenApiServiceServiceChannelAstiInBase addExtraTypesItem(VmOpenApiExtraType extraTypesItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V7VmOpenApiServiceServiceChannelAstiInBase addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase contactDetails(VmOpenApiContactDetailsInBase contactDetails) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase deleteAllExtraTypes(Boolean deleteAllExtraTypes) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase deleteAllDescriptions(Boolean deleteAllDescriptions) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelAstiInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiServiceServiceChannelAstiInBase v7VmOpenApiServiceServiceChannelAstiInBase = (V7VmOpenApiServiceServiceChannelAstiInBase) o;
    return Objects.equals(this.serviceChannelId, v7VmOpenApiServiceServiceChannelAstiInBase.serviceChannelId) &&
        Objects.equals(this.serviceChargeType, v7VmOpenApiServiceServiceChannelAstiInBase.serviceChargeType) &&
        Objects.equals(this.description, v7VmOpenApiServiceServiceChannelAstiInBase.description) &&
        Objects.equals(this.extraTypes, v7VmOpenApiServiceServiceChannelAstiInBase.extraTypes) &&
        Objects.equals(this.serviceHours, v7VmOpenApiServiceServiceChannelAstiInBase.serviceHours) &&
        Objects.equals(this.contactDetails, v7VmOpenApiServiceServiceChannelAstiInBase.contactDetails) &&
        Objects.equals(this.deleteServiceChargeType, v7VmOpenApiServiceServiceChannelAstiInBase.deleteServiceChargeType) &&
        Objects.equals(this.deleteAllExtraTypes, v7VmOpenApiServiceServiceChannelAstiInBase.deleteAllExtraTypes) &&
        Objects.equals(this.deleteAllDescriptions, v7VmOpenApiServiceServiceChannelAstiInBase.deleteAllDescriptions) &&
        Objects.equals(this.deleteAllServiceHours, v7VmOpenApiServiceServiceChannelAstiInBase.deleteAllServiceHours);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceChannelId, serviceChargeType, description, extraTypes, serviceHours, contactDetails, deleteServiceChargeType, deleteAllExtraTypes, deleteAllDescriptions, deleteAllServiceHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiServiceServiceChannelAstiInBase {\n");
