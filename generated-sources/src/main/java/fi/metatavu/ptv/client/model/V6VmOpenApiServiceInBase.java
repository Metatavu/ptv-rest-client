...
public class V6VmOpenApiServiceInBase   {
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "Service type. Possible values are: Service, PermissionAndObligation or ProfessionalQualifications.  NOTE! If service type has been defined within attached statutory service general description, the type for service is ignored.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "List of service class urls. Sample url: http://urn.fi/URN:NBN:fi:au:ptvl:v1065.  NOTE! If service class has been defined within attached statutory service general description, the service class is not added for service.")
  ...
  **/
   ...
   * @return targetGroups
  **/
  @ApiModelProperty(example = "null", value = "List of target group urls. Sample url: http://urn.fi/URN:NBN:fi:au:ptvl:v2004.  NOTE! If target group has been defined within attached statutory service general description, the target group is not added for service.")
