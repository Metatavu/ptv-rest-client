...
public class V7VmOpenApiServiceServiceChannelBySourceAsti {
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti serviceChannelSourceId(String serviceChannelSourceId) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti description(List<VmOpenApiLocalizedListItem> description) {
    this.description = description;
    return this;
  }

  public V7VmOpenApiServiceServiceChannelBySourceAsti addDescriptionItem(VmOpenApiLocalizedListItem descriptionItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti serviceChargeType(String serviceChargeType) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti extraTypes(List<VmOpenApiExtraType> extraTypes) {
    this.extraTypes = extraTypes;
    return this;
  }

  public V7VmOpenApiServiceServiceChannelBySourceAsti addExtraTypesItem(VmOpenApiExtraType extraTypesItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V7VmOpenApiServiceServiceChannelBySourceAsti addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti contactDetails(VmOpenApiContactDetailsInBase contactDetails) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti deleteServiceChargeType(Boolean deleteServiceChargeType) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti deleteAllDescriptions(Boolean deleteAllDescriptions) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti deleteAllExtraTypes(Boolean deleteAllExtraTypes) {
  ...
  **/
  ...
  public V7VmOpenApiServiceServiceChannelBySourceAsti deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiServiceServiceChannelBySourceAsti v7VmOpenApiServiceServiceChannelBySourceAsti = (V7VmOpenApiServiceServiceChannelBySourceAsti) o;
    return Objects.equals(this.serviceChannelSourceId, v7VmOpenApiServiceServiceChannelBySourceAsti.serviceChannelSourceId) &&
        Objects.equals(this.description, v7VmOpenApiServiceServiceChannelBySourceAsti.description) &&
        Objects.equals(this.serviceChargeType, v7VmOpenApiServiceServiceChannelBySourceAsti.serviceChargeType) &&
        Objects.equals(this.extraTypes, v7VmOpenApiServiceServiceChannelBySourceAsti.extraTypes) &&
        Objects.equals(this.serviceHours, v7VmOpenApiServiceServiceChannelBySourceAsti.serviceHours) &&
        Objects.equals(this.contactDetails, v7VmOpenApiServiceServiceChannelBySourceAsti.contactDetails) &&
        Objects.equals(this.deleteServiceChargeType, v7VmOpenApiServiceServiceChannelBySourceAsti.deleteServiceChargeType) &&
        Objects.equals(this.deleteAllDescriptions, v7VmOpenApiServiceServiceChannelBySourceAsti.deleteAllDescriptions) &&
        Objects.equals(this.deleteAllExtraTypes, v7VmOpenApiServiceServiceChannelBySourceAsti.deleteAllExtraTypes) &&
        Objects.equals(this.deleteAllServiceHours, v7VmOpenApiServiceServiceChannelBySourceAsti.deleteAllServiceHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiServiceServiceChannelBySourceAsti {\n");
