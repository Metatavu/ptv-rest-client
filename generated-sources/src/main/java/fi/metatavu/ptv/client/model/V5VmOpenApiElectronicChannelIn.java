...
public class V5VmOpenApiElectronicChannelIn   {
  ...
  public V5VmOpenApiElectronicChannelIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn organizationId(String organizationId) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn areaType(String areaType) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addAreasItem(VmOpenApiAreaIn areasItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn signatureQuantity(String signatureQuantity) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn requiresSignature(Boolean requiresSignature) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn requiresAuthentication(Boolean requiresAuthentication) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn attachments(List<VmOpenApiAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addAttachmentsItem(VmOpenApiAttachment attachmentsItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V5VmOpenApiElectronicChannelIn addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V5VmOpenApiElectronicChannelIn isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiElectronicChannelIn v5VmOpenApiElectronicChannelIn = (V5VmOpenApiElectronicChannelIn) o;
    return Objects.equals(this.sourceId, v5VmOpenApiElectronicChannelIn.sourceId) &&
        Objects.equals(this.organizationId, v5VmOpenApiElectronicChannelIn.organizationId) &&
        Objects.equals(this.serviceChannelNames, v5VmOpenApiElectronicChannelIn.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v5VmOpenApiElectronicChannelIn.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v5VmOpenApiElectronicChannelIn.areaType) &&
        Objects.equals(this.areas, v5VmOpenApiElectronicChannelIn.areas) &&
        Objects.equals(this.signatureQuantity, v5VmOpenApiElectronicChannelIn.signatureQuantity) &&
        Objects.equals(this.requiresSignature, v5VmOpenApiElectronicChannelIn.requiresSignature) &&
        Objects.equals(this.requiresAuthentication, v5VmOpenApiElectronicChannelIn.requiresAuthentication) &&
        Objects.equals(this.urls, v5VmOpenApiElectronicChannelIn.urls) &&
        Objects.equals(this.attachments, v5VmOpenApiElectronicChannelIn.attachments) &&
        Objects.equals(this.supportPhones, v5VmOpenApiElectronicChannelIn.supportPhones) &&
        Objects.equals(this.supportEmails, v5VmOpenApiElectronicChannelIn.supportEmails) &&
        Objects.equals(this.serviceHours, v5VmOpenApiElectronicChannelIn.serviceHours) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiElectronicChannelIn.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v5VmOpenApiElectronicChannelIn.isVisibleForAll);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelNames, serviceChannelDescriptions, areaType, areas, signatureQuantity, requiresSignature, requiresAuthentication, urls, attachments, supportPhones, supportEmails, serviceHours, publishingStatus, isVisibleForAll);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiElectronicChannelIn {\n");
