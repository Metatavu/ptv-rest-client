...
import fi.metatavu.ptv.client.model.V7VmOpenApiServiceServiceChannelAstiInBase;
...
public class V7VmOpenApiServiceAndChannelRelationAstiInBase {
  @JsonProperty("deleteAllChannelRelations")
  private Boolean deleteAllChannelRelations = null;

  @JsonProperty("channelRelations")
  private List<V7VmOpenApiServiceServiceChannelAstiInBase> channelRelations = null;

  public V7VmOpenApiServiceAndChannelRelationAstiInBase deleteAllChannelRelations(Boolean deleteAllChannelRelations) {
  ...
  **/
  ...
  public V7VmOpenApiServiceAndChannelRelationAstiInBase channelRelations(List<V7VmOpenApiServiceServiceChannelAstiInBase> channelRelations) {
    this.channelRelations = channelRelations;
    return this;
  }

  public V7VmOpenApiServiceAndChannelRelationAstiInBase addChannelRelationsItem(V7VmOpenApiServiceServiceChannelAstiInBase channelRelationsItem) {
    if (this.channelRelations == null) {
      this.channelRelations = new ArrayList<V7VmOpenApiServiceServiceChannelAstiInBase>();
    }
  ...
  **/
  ...
  public List<V7VmOpenApiServiceServiceChannelAstiInBase> getChannelRelations() {
    return channelRelations;
  }

  public void setChannelRelations(List<V7VmOpenApiServiceServiceChannelAstiInBase> channelRelations) {
    this.channelRelations = channelRelations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V7VmOpenApiServiceAndChannelRelationAstiInBase v7VmOpenApiServiceAndChannelRelationAstiInBase = (V7VmOpenApiServiceAndChannelRelationAstiInBase) o;
    return Objects.equals(this.deleteAllChannelRelations, v7VmOpenApiServiceAndChannelRelationAstiInBase.deleteAllChannelRelations) &&
        Objects.equals(this.channelRelations, v7VmOpenApiServiceAndChannelRelationAstiInBase.channelRelations);
  }
  ...
  public String toString() {
    ...
    sb.append("class V7VmOpenApiServiceAndChannelRelationAstiInBase {\n");
