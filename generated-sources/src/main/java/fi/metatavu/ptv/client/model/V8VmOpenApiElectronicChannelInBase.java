 ...
 */
@ApiModel(description = "OPEN API V8 - View Model of electronic channel for IN api - base")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-08-06T13:25:17.639+03:00")
public class V8VmOpenApiElectronicChannelInBase {
  ...
  public V8VmOpenApiElectronicChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase areaType(String areaType) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addAreasItem(VmOpenApiAreaIn areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase signatureQuantity(String signatureQuantity) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase requiresSignature(Boolean requiresSignature) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase requiresAuthentication(Boolean requiresAuthentication) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase webPage(List<VmOpenApiLanguageItem> webPage) {
    this.webPage = webPage;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addWebPageItem(VmOpenApiLanguageItem webPageItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase attachments(List<VmOpenApiAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addAttachmentsItem(VmOpenApiAttachment attachmentsItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V8VmOpenApiElectronicChannelInBase addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase deleteAllAttachments(Boolean deleteAllAttachments) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase deleteAllWebPages(Boolean deleteAllWebPages) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase deleteAllSupportEmails(Boolean deleteAllSupportEmails) {
  ...
  **/
  ...
  public V8VmOpenApiElectronicChannelInBase deleteAllSupportPhones(Boolean deleteAllSupportPhones) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiElectronicChannelInBase v8VmOpenApiElectronicChannelInBase = (V8VmOpenApiElectronicChannelInBase) o;
    return Objects.equals(this.sourceId, v8VmOpenApiElectronicChannelInBase.sourceId) &&
        Objects.equals(this.serviceChannelDescriptions, v8VmOpenApiElectronicChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.organizationId, v8VmOpenApiElectronicChannelInBase.organizationId) &&
        Objects.equals(this.areaType, v8VmOpenApiElectronicChannelInBase.areaType) &&
        Objects.equals(this.serviceChannelNames, v8VmOpenApiElectronicChannelInBase.serviceChannelNames) &&
        Objects.equals(this.areas, v8VmOpenApiElectronicChannelInBase.areas) &&
        Objects.equals(this.signatureQuantity, v8VmOpenApiElectronicChannelInBase.signatureQuantity) &&
        Objects.equals(this.requiresSignature, v8VmOpenApiElectronicChannelInBase.requiresSignature) &&
        Objects.equals(this.requiresAuthentication, v8VmOpenApiElectronicChannelInBase.requiresAuthentication) &&
        Objects.equals(this.webPage, v8VmOpenApiElectronicChannelInBase.webPage) &&
        Objects.equals(this.attachments, v8VmOpenApiElectronicChannelInBase.attachments) &&
        Objects.equals(this.supportPhones, v8VmOpenApiElectronicChannelInBase.supportPhones) &&
        Objects.equals(this.supportEmails, v8VmOpenApiElectronicChannelInBase.supportEmails) &&
        Objects.equals(this.serviceHours, v8VmOpenApiElectronicChannelInBase.serviceHours) &&
        Objects.equals(this.publishingStatus, v8VmOpenApiElectronicChannelInBase.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v8VmOpenApiElectronicChannelInBase.isVisibleForAll) &&
        Objects.equals(this.deleteAllAttachments, v8VmOpenApiElectronicChannelInBase.deleteAllAttachments) &&
        Objects.equals(this.deleteAllWebPages, v8VmOpenApiElectronicChannelInBase.deleteAllWebPages) &&
        Objects.equals(this.deleteAllServiceHours, v8VmOpenApiElectronicChannelInBase.deleteAllServiceHours) &&
        Objects.equals(this.deleteAllSupportEmails, v8VmOpenApiElectronicChannelInBase.deleteAllSupportEmails) &&
        Objects.equals(this.deleteAllSupportPhones, v8VmOpenApiElectronicChannelInBase.deleteAllSupportPhones);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, serviceChannelDescriptions, organizationId, areaType, serviceChannelNames, areas, signatureQuantity, requiresSignature, requiresAuthentication, webPage, attachments, supportPhones, supportEmails, serviceHours, publishingStatus, isVisibleForAll, deleteAllAttachments, deleteAllWebPages, deleteAllServiceHours, deleteAllSupportEmails, deleteAllSupportPhones);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiElectronicChannelInBase {\n");
