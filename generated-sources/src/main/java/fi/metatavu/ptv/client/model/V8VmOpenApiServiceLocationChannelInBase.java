 ...
 */
@ApiModel(description = "OPEN API V8 - View Model of service location channel for IN api - base")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-08-06T13:25:17.639+03:00")
public class V8VmOpenApiServiceLocationChannelInBase {
  ...
  public V8VmOpenApiServiceLocationChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase areaType(String areaType) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addAreasItem(VmOpenApiAreaIn areasItem) {
    if (this.areas == null) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase emails(List<VmOpenApiLanguageItem> emails) {
    this.emails = emails;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addEmailsItem(VmOpenApiLanguageItem emailsItem) {
    if (this.emails == null) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase faxNumbers(List<V4VmOpenApiPhoneSimple> faxNumbers) {
    this.faxNumbers = faxNumbers;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addFaxNumbersItem(V4VmOpenApiPhoneSimple faxNumbersItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase phoneNumbers(List<V4VmOpenApiPhone> phoneNumbers) {
    this.phoneNumbers = phoneNumbers;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addPhoneNumbersItem(V4VmOpenApiPhone phoneNumbersItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase webPages(List<VmOpenApiWebPageWithOrderNumber> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addWebPagesItem(VmOpenApiWebPageWithOrderNumber webPagesItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase addresses(List<V7VmOpenApiAddressWithMovingIn> addresses) {
    this.addresses = addresses;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addAddressesItem(V7VmOpenApiAddressWithMovingIn addressesItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase serviceHours(List<V8VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V8VmOpenApiServiceLocationChannelInBase addServiceHoursItem(V8VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase deleteAllEmails(Boolean deleteAllEmails) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase deleteAllPhoneNumbers(Boolean deleteAllPhoneNumbers) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase deleteAllFaxNumbers(Boolean deleteAllFaxNumbers) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase deleteAllWebPages(Boolean deleteAllWebPages) {
  ...
  **/
  ...
  public V8VmOpenApiServiceLocationChannelInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V8VmOpenApiServiceLocationChannelInBase v8VmOpenApiServiceLocationChannelInBase = (V8VmOpenApiServiceLocationChannelInBase) o;
    return Objects.equals(this.sourceId, v8VmOpenApiServiceLocationChannelInBase.sourceId) &&
        Objects.equals(this.serviceChannelDescriptions, v8VmOpenApiServiceLocationChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.organizationId, v8VmOpenApiServiceLocationChannelInBase.organizationId) &&
        Objects.equals(this.areaType, v8VmOpenApiServiceLocationChannelInBase.areaType) &&
        Objects.equals(this.serviceChannelNames, v8VmOpenApiServiceLocationChannelInBase.serviceChannelNames) &&
        Objects.equals(this.areas, v8VmOpenApiServiceLocationChannelInBase.areas) &&
        Objects.equals(this.emails, v8VmOpenApiServiceLocationChannelInBase.emails) &&
        Objects.equals(this.faxNumbers, v8VmOpenApiServiceLocationChannelInBase.faxNumbers) &&
        Objects.equals(this.phoneNumbers, v8VmOpenApiServiceLocationChannelInBase.phoneNumbers) &&
        Objects.equals(this.languages, v8VmOpenApiServiceLocationChannelInBase.languages) &&
        Objects.equals(this.webPages, v8VmOpenApiServiceLocationChannelInBase.webPages) &&
        Objects.equals(this.addresses, v8VmOpenApiServiceLocationChannelInBase.addresses) &&
        Objects.equals(this.serviceHours, v8VmOpenApiServiceLocationChannelInBase.serviceHours) &&
        Objects.equals(this.deleteAllEmails, v8VmOpenApiServiceLocationChannelInBase.deleteAllEmails) &&
        Objects.equals(this.deleteAllPhoneNumbers, v8VmOpenApiServiceLocationChannelInBase.deleteAllPhoneNumbers) &&
        Objects.equals(this.deleteAllFaxNumbers, v8VmOpenApiServiceLocationChannelInBase.deleteAllFaxNumbers) &&
        Objects.equals(this.publishingStatus, v8VmOpenApiServiceLocationChannelInBase.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v8VmOpenApiServiceLocationChannelInBase.isVisibleForAll) &&
        Objects.equals(this.deleteAllWebPages, v8VmOpenApiServiceLocationChannelInBase.deleteAllWebPages) &&
        Objects.equals(this.deleteAllServiceHours, v8VmOpenApiServiceLocationChannelInBase.deleteAllServiceHours);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, serviceChannelDescriptions, organizationId, areaType, serviceChannelNames, areas, emails, faxNumbers, phoneNumbers, languages, webPages, addresses, serviceHours, deleteAllEmails, deleteAllPhoneNumbers, deleteAllFaxNumbers, publishingStatus, isVisibleForAll, deleteAllWebPages, deleteAllServiceHours);
  }
  ...
  public String toString() {
    ...
    sb.append("class V8VmOpenApiServiceLocationChannelInBase {\n");
