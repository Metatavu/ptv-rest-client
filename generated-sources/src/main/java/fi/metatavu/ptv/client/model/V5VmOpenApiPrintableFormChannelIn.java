 ...
 */
@ApiModel(description = "OPEN API V5 - View Model of printable from channel for IN api")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-05-04T15:53:23.977+03:00")
public class V5VmOpenApiPrintableFormChannelIn   {
  ...
  public V5VmOpenApiPrintableFormChannelIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn organizationId(String organizationId) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "List of localized service channel descriptions. (Max.Length: 2500 Description). (Max.Length: 150 ShortDescription).")
  ...
  public V5VmOpenApiPrintableFormChannelIn areaType(String areaType) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn areas(List<VmOpenApiAreaIn> areas) {
    this.areas = areas;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addAreasItem(VmOpenApiAreaIn areasItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn formIdentifier(List<VmOpenApiLanguageItem> formIdentifier) {
    this.formIdentifier = formIdentifier;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addFormIdentifierItem(VmOpenApiLanguageItem formIdentifierItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn formReceiver(List<VmOpenApiLanguageItem> formReceiver) {
    this.formReceiver = formReceiver;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addFormReceiverItem(VmOpenApiLanguageItem formReceiverItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn deliveryAddress(V5VmOpenApiAddressIn deliveryAddress) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn channelUrls(List<VmOpenApiLocalizedListItem> channelUrls) {
    this.channelUrls = channelUrls;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addChannelUrlsItem(VmOpenApiLocalizedListItem channelUrlsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn attachments(List<VmOpenApiAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addAttachmentsItem(VmOpenApiAttachment attachmentsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V5VmOpenApiPrintableFormChannelIn addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V5VmOpenApiPrintableFormChannelIn isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiPrintableFormChannelIn v5VmOpenApiPrintableFormChannelIn = (V5VmOpenApiPrintableFormChannelIn) o;
    return Objects.equals(this.sourceId, v5VmOpenApiPrintableFormChannelIn.sourceId) &&
        Objects.equals(this.organizationId, v5VmOpenApiPrintableFormChannelIn.organizationId) &&
        Objects.equals(this.serviceChannelNames, v5VmOpenApiPrintableFormChannelIn.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v5VmOpenApiPrintableFormChannelIn.serviceChannelDescriptions) &&
        Objects.equals(this.areaType, v5VmOpenApiPrintableFormChannelIn.areaType) &&
        Objects.equals(this.areas, v5VmOpenApiPrintableFormChannelIn.areas) &&
        Objects.equals(this.formIdentifier, v5VmOpenApiPrintableFormChannelIn.formIdentifier) &&
        Objects.equals(this.formReceiver, v5VmOpenApiPrintableFormChannelIn.formReceiver) &&
        Objects.equals(this.deliveryAddress, v5VmOpenApiPrintableFormChannelIn.deliveryAddress) &&
        Objects.equals(this.channelUrls, v5VmOpenApiPrintableFormChannelIn.channelUrls) &&
        Objects.equals(this.attachments, v5VmOpenApiPrintableFormChannelIn.attachments) &&
        Objects.equals(this.supportPhones, v5VmOpenApiPrintableFormChannelIn.supportPhones) &&
        Objects.equals(this.supportEmails, v5VmOpenApiPrintableFormChannelIn.supportEmails) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiPrintableFormChannelIn.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v5VmOpenApiPrintableFormChannelIn.isVisibleForAll);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelNames, serviceChannelDescriptions, areaType, areas, formIdentifier, formReceiver, deliveryAddress, channelUrls, attachments, supportPhones, supportEmails, publishingStatus, isVisibleForAll);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiPrintableFormChannelIn {\n");
