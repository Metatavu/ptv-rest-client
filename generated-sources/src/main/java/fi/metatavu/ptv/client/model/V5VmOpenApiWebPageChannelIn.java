...
public class V5VmOpenApiWebPageChannelIn   {
  ...
  public V5VmOpenApiWebPageChannelIn sourceId(String sourceId) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn organizationId(String organizationId) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V5VmOpenApiWebPageChannelIn addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V5VmOpenApiWebPageChannelIn addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V5VmOpenApiWebPageChannelIn addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V5VmOpenApiWebPageChannelIn addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V5VmOpenApiWebPageChannelIn addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public V5VmOpenApiWebPageChannelIn addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V5VmOpenApiWebPageChannelIn isVisibleForAll(Boolean isVisibleForAll) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V5VmOpenApiWebPageChannelIn v5VmOpenApiWebPageChannelIn = (V5VmOpenApiWebPageChannelIn) o;
    return Objects.equals(this.sourceId, v5VmOpenApiWebPageChannelIn.sourceId) &&
        Objects.equals(this.organizationId, v5VmOpenApiWebPageChannelIn.organizationId) &&
        Objects.equals(this.serviceChannelNames, v5VmOpenApiWebPageChannelIn.serviceChannelNames) &&
        Objects.equals(this.serviceChannelDescriptions, v5VmOpenApiWebPageChannelIn.serviceChannelDescriptions) &&
        Objects.equals(this.urls, v5VmOpenApiWebPageChannelIn.urls) &&
        Objects.equals(this.supportPhones, v5VmOpenApiWebPageChannelIn.supportPhones) &&
        Objects.equals(this.supportEmails, v5VmOpenApiWebPageChannelIn.supportEmails) &&
        Objects.equals(this.languages, v5VmOpenApiWebPageChannelIn.languages) &&
        Objects.equals(this.publishingStatus, v5VmOpenApiWebPageChannelIn.publishingStatus) &&
        Objects.equals(this.isVisibleForAll, v5VmOpenApiWebPageChannelIn.isVisibleForAll);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelNames, serviceChannelDescriptions, urls, supportPhones, supportEmails, languages, publishingStatus, isVisibleForAll);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V5VmOpenApiWebPageChannelIn {\n");
