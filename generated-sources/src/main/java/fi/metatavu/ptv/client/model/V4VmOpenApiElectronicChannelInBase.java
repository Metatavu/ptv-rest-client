 ...
 */
@ApiModel(description = "OPEN API V4 - View Model of electronic channel for IN api - base")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-04-10T07:09:28.826+03:00")
public class V4VmOpenApiElectronicChannelInBase   {
  ...
  public V4VmOpenApiElectronicChannelInBase sourceId(String sourceId) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase organizationId(String organizationId) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase serviceChannelDescriptions(List<VmOpenApiLocalizedListItem> serviceChannelDescriptions) {
    this.serviceChannelDescriptions = serviceChannelDescriptions;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addServiceChannelDescriptionsItem(VmOpenApiLocalizedListItem serviceChannelDescriptionsItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase serviceChannelNames(List<VmOpenApiLanguageItem> serviceChannelNames) {
    this.serviceChannelNames = serviceChannelNames;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addServiceChannelNamesItem(VmOpenApiLanguageItem serviceChannelNamesItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase signatureQuantity(String signatureQuantity) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase requiresSignature(Boolean requiresSignature) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase requiresAuthentication(Boolean requiresAuthentication) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase urls(List<VmOpenApiLanguageItem> urls) {
    this.urls = urls;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addUrlsItem(VmOpenApiLanguageItem urlsItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase attachments(List<VmOpenApiAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addAttachmentsItem(VmOpenApiAttachment attachmentsItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase supportPhones(List<V4VmOpenApiPhone> supportPhones) {
    this.supportPhones = supportPhones;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addSupportPhonesItem(V4VmOpenApiPhone supportPhonesItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase supportEmails(List<VmOpenApiLanguageItem> supportEmails) {
    this.supportEmails = supportEmails;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addSupportEmailsItem(VmOpenApiLanguageItem supportEmailsItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase serviceHours(List<V4VmOpenApiServiceHour> serviceHours) {
    this.serviceHours = serviceHours;
    return this;
  }

  public V4VmOpenApiElectronicChannelInBase addServiceHoursItem(V4VmOpenApiServiceHour serviceHoursItem) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase publishingStatus(String publishingStatus) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase deleteAllAttachments(Boolean deleteAllAttachments) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase deleteAllWebPages(Boolean deleteAllWebPages) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase deleteAllServiceHours(Boolean deleteAllServiceHours) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase deleteAllSupportEmails(Boolean deleteAllSupportEmails) {
  ...
  **/
  ...
  public V4VmOpenApiElectronicChannelInBase deleteAllSupportPhones(Boolean deleteAllSupportPhones) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiElectronicChannelInBase v4VmOpenApiElectronicChannelInBase = (V4VmOpenApiElectronicChannelInBase) o;
    return Objects.equals(this.sourceId, v4VmOpenApiElectronicChannelInBase.sourceId) &&
        Objects.equals(this.organizationId, v4VmOpenApiElectronicChannelInBase.organizationId) &&
        Objects.equals(this.serviceChannelDescriptions, v4VmOpenApiElectronicChannelInBase.serviceChannelDescriptions) &&
        Objects.equals(this.serviceChannelNames, v4VmOpenApiElectronicChannelInBase.serviceChannelNames) &&
        Objects.equals(this.signatureQuantity, v4VmOpenApiElectronicChannelInBase.signatureQuantity) &&
        Objects.equals(this.requiresSignature, v4VmOpenApiElectronicChannelInBase.requiresSignature) &&
        Objects.equals(this.requiresAuthentication, v4VmOpenApiElectronicChannelInBase.requiresAuthentication) &&
        Objects.equals(this.urls, v4VmOpenApiElectronicChannelInBase.urls) &&
        Objects.equals(this.attachments, v4VmOpenApiElectronicChannelInBase.attachments) &&
        Objects.equals(this.supportPhones, v4VmOpenApiElectronicChannelInBase.supportPhones) &&
        Objects.equals(this.supportEmails, v4VmOpenApiElectronicChannelInBase.supportEmails) &&
        Objects.equals(this.serviceHours, v4VmOpenApiElectronicChannelInBase.serviceHours) &&
        Objects.equals(this.publishingStatus, v4VmOpenApiElectronicChannelInBase.publishingStatus) &&
        Objects.equals(this.deleteAllAttachments, v4VmOpenApiElectronicChannelInBase.deleteAllAttachments) &&
        Objects.equals(this.deleteAllWebPages, v4VmOpenApiElectronicChannelInBase.deleteAllWebPages) &&
        Objects.equals(this.deleteAllServiceHours, v4VmOpenApiElectronicChannelInBase.deleteAllServiceHours) &&
        Objects.equals(this.deleteAllSupportEmails, v4VmOpenApiElectronicChannelInBase.deleteAllSupportEmails) &&
        Objects.equals(this.deleteAllSupportPhones, v4VmOpenApiElectronicChannelInBase.deleteAllSupportPhones);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, organizationId, serviceChannelDescriptions, serviceChannelNames, signatureQuantity, requiresSignature, requiresAuthentication, urls, attachments, supportPhones, supportEmails, serviceHours, publishingStatus, deleteAllAttachments, deleteAllWebPages, deleteAllServiceHours, deleteAllSupportEmails, deleteAllSupportPhones);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V4VmOpenApiElectronicChannelInBase {\n");
