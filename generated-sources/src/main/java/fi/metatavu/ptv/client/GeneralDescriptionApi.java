...
import fi.metatavu.ptv.client.model.V7VmOpenApiGeneralDescription;
...
public class GeneralDescriptionApi {
   ...
   */
  public ApiResponse<V7VmOpenApiGeneralDescription> apiV7GeneralDescriptionByIdGet(String id) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v7/GeneralDescription/{id}"
      .replaceAll("\\{" + "id" + "\\}", id);
      
    ResultType<V7VmOpenApiGeneralDescription> resultType = new ResultType<V7VmOpenApiGeneralDescription>() {};
   ...
   */
  public ApiResponse<V7VmOpenApiGeneralDescription> apiV7GeneralDescriptionByIdPut(String id, V6VmOpenApiGeneralDescriptionInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
...
if (page != null)
    ...
    String path = "/api/v7/GeneralDescription";
   ...
   * @param request The general description data. (optional)
   */
  public ApiResponse<V7VmOpenApiGeneralDescription> apiV7GeneralDescriptionPost(V6VmOpenApiGeneralDescriptionIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
