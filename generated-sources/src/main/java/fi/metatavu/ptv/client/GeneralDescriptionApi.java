...
import fi.metatavu.ptv.client.model.VmOpenApiGeneralDescriptionInBase;
...
public class GeneralDescriptionApi {
   ...
   */
  public ApiResponse<V4VmOpenApiGeneralDescription> apiV5GeneralDescriptionByIdGet(String id) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v5/GeneralDescription/{id}"
      .replaceAll("\\{" + "id" + "\\}", id);
   ...
   */
  public ApiResponse<V4VmOpenApiGeneralDescription> apiV5GeneralDescriptionByIdPut(String id, VmOpenApiGeneralDescriptionInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   */
  public ApiResponse<V3VmOpenApiGuidPage> apiV5GeneralDescriptionGet(OffsetDateTime date, Integer page) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
    if (date != null)
...
if (page != null)
    ...
    String path = "/api/v5/GeneralDescription";
   ...
   * @param request The general description data. (optional)
   */
  public ApiResponse<V4VmOpenApiGeneralDescription> apiV5GeneralDescriptionPost(VmOpenApiGeneralDescriptionIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
