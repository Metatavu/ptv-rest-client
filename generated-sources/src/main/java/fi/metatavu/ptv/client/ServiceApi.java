...
import fi.metatavu.ptv.client.model.V4VmOpenApiServiceInBase;
import java.time.OffsetDateTime;
import fi.metatavu.ptv.client.model.V3VmOpenApiGuidPage;
import fi.metatavu.ptv.client.model.V4VmOpenApiServiceIn;
...
public class ServiceApi {
   ...
   */
  public ApiResponse<V4VmOpenApiService> apiV4ServiceByIdGet(String id) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v4/Service/{id}"
      .replaceAll("\\{" + "id" + "\\}", id);
      
    ResultType<V4VmOpenApiService> resultType = new ResultType<V4VmOpenApiService>() {};
   ...
   */
  public ApiResponse<V4VmOpenApiService> apiV4ServiceByIdPut(String id, V4VmOpenApiServiceInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   */
  public ApiResponse<V3VmOpenApiGuidPage> apiV4ServiceGet(OffsetDateTime date, Integer page) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
    if (date != null)
...
if (page != null)
   ...
   * @param request The service data. (optional)
   */
  public ApiResponse<V4VmOpenApiService> apiV4ServicePost(V4VmOpenApiServiceIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   */
  public ApiResponse<List<String>> apiV4ServiceServiceAndChannelPost(List<V2VmOpenApiServiceAndChannel> request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v4/Service/ServiceAndChannel";
   ...
   * @param date Supports only format \&quot;yyyy-MM-ddTHH:mm:ss\&quot; (optional)
   */
  public ApiResponse<List<V4VmOpenApiService>> apiV4ServiceServiceChannelByServiceChannelIdGet(String serviceChannelId, OffsetDateTime date) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
    if (date != null)
    queryParams.put("date", date);
    ...
    String path = "/api/v4/Service/serviceChannel/{serviceChannelId}"
      .replaceAll("\\{" + "serviceChannelId" + "\\}", serviceChannelId);
      
    ResultType<List<V4VmOpenApiService>> resultType = new ResultType<List<V4VmOpenApiService>>() {};
    return client.doGETRequest(path, resultType, queryParams, formParams);
  }
  /**
   * Updates the defined service with the data provided as input.
   ...
   * @param request The service data (optional)
   */
  public ApiResponse<V4VmOpenApiService> apiV4ServiceSourceIdBySourceIdPut(String sourceId, V4VmOpenApiServiceInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v4/Service/sourceId/{sourceId}"
