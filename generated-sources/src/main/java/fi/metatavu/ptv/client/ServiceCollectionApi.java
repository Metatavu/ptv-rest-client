...
public class ServiceCollectionApi {
   ...
   */
  public ApiResponse<V7VmOpenApiServiceCollection> get(String id) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v10/ServiceCollection/{id}"
      .replaceAll("\\{" + "id" + "\\}", id);
...
if (archived != null)
    ...
    String path = "/api/v10/ServiceCollection";
   ...
   */
  public ApiResponse<V7VmOpenApiServiceCollection> post(V7VmOpenApiServiceCollectionIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   * @param request The service collection data (optional)
   */
  public ApiResponse<V7VmOpenApiServiceCollection> put(String id, V7VmOpenApiServiceCollectionInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   * @param request The service collection data (optional)
   */
  public ApiResponse<V7VmOpenApiServiceCollection> putBySource(String sourceId, V7VmOpenApiServiceCollectionInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v10/ServiceCollection/sourceId/{sourceId}"
