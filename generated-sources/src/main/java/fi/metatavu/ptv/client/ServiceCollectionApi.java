...
public class ServiceCollectionApi {
   ...
   */
  public ApiResponse<V7VmOpenApiServiceCollection> apiV9ServiceCollectionByIdGet(String id) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v9/ServiceCollection/{id}"
      .replaceAll("\\{" + "id" + "\\}", id);
   ...
   */
  public ApiResponse<V7VmOpenApiServiceCollection> apiV9ServiceCollectionByIdPut(String id, V7VmOpenApiServiceCollectionInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   * @param archived Get archived items by setting archived to true. (optional, default to false)
   */
  public ApiResponse<V3VmOpenApiGuidPage> apiV9ServiceCollectionGet(@com.fasterxml.jackson.databind.annotation.JsonSerialize(using = com.fasterxml.jackson.datatype.jsr310.ser.OffsetDateTimeSerializer.class) @com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = fi.metatavu.ptv.client.OffsetDateTimeDeserializer.class) java.time.OffsetDateTime date, @com.fasterxml.jackson.databind.annotation.JsonSerialize(using = com.fasterxml.jackson.datatype.jsr310.ser.OffsetDateTimeSerializer.class) @com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = fi.metatavu.ptv.client.OffsetDateTimeDeserializer.class) java.time.OffsetDateTime dateBefore, Integer page, Boolean archived) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
    if (date != null)
...
if (archived != null)
    ...
    String path = "/api/v9/ServiceCollection";
   ...
   * @param request The service collection data. (optional)
   */
  public ApiResponse<V7VmOpenApiServiceCollection> apiV9ServiceCollectionPost(V7VmOpenApiServiceCollectionIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
   ...
   * @param request The service collection data (optional)
   */
  public ApiResponse<V7VmOpenApiServiceCollection> apiV9ServiceCollectionSourceIdBySourceIdPut(String sourceId, V7VmOpenApiServiceCollectionInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v9/ServiceCollection/sourceId/{sourceId}"
