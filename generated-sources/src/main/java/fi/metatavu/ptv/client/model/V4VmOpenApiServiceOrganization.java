...
public class V4VmOpenApiServiceOrganization   {
  ...
  public V4VmOpenApiServiceOrganization additionalInformation(List<VmOpenApiLanguageItem> additionalInformation) {
    this.additionalInformation = additionalInformation;
    return this;
  }

  public V4VmOpenApiServiceOrganization addAdditionalInformationItem(VmOpenApiLanguageItem additionalInformationItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Localized list of additional information. (Max.Length: 150).")
  ...
  public V4VmOpenApiServiceOrganization organizationId(String organizationId) {
  ...
  **/
  ...
  public V4VmOpenApiServiceOrganization roleType(String roleType) {
  ...
  **/
  ...
  public V4VmOpenApiServiceOrganization provisionType(String provisionType) {
  ...
  **/
  ...
  public V4VmOpenApiServiceOrganization webPages(List<V4VmOpenApiWebPage> webPages) {
    this.webPages = webPages;
    return this;
  }

  public V4VmOpenApiServiceOrganization addWebPagesItem(V4VmOpenApiWebPage webPagesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V4VmOpenApiServiceOrganization v4VmOpenApiServiceOrganization = (V4VmOpenApiServiceOrganization) o;
    return Objects.equals(this.additionalInformation, v4VmOpenApiServiceOrganization.additionalInformation) &&
        Objects.equals(this.organizationId, v4VmOpenApiServiceOrganization.organizationId) &&
        Objects.equals(this.roleType, v4VmOpenApiServiceOrganization.roleType) &&
        Objects.equals(this.provisionType, v4VmOpenApiServiceOrganization.provisionType) &&
        Objects.equals(this.webPages, v4VmOpenApiServiceOrganization.webPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class V4VmOpenApiServiceOrganization {\n");
