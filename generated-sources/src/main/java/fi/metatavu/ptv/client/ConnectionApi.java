...
import fi.metatavu.ptv.client.model.V8VmOpenApiChannelServicesIn;
import fi.metatavu.ptv.client.model.V8VmOpenApiService;
import fi.metatavu.ptv.client.model.V8VmOpenApiServiceAndChannelIn;
import fi.metatavu.ptv.client.model.V8VmOpenApiServiceAndChannelRelationAstiInBase;
import fi.metatavu.ptv.client.model.V8VmOpenApiServiceAndChannelRelationBySource;
import fi.metatavu.ptv.client.model.V8VmOpenApiServiceAndChannelRelationBySourceAsti;
import fi.metatavu.ptv.client.model.V8VmOpenApiServiceAndChannelRelationBySourceInBase;
...
public class ConnectionApi {
   ...
   */
  public ApiResponse<V8VmOpenApiService> apiV8ConnectionASTIServiceChannelIdByServiceChannelIdPut(String serviceChannelId, V8VmOpenApiChannelServicesIn request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection/ASTI/serviceChannelId/{serviceChannelId}"
   ...
   * @param request A list of service channels. (optional)
   */
  public ApiResponse<V8VmOpenApiService> apiV8ConnectionASTIServiceIdByServiceIdPut(String serviceId, V8VmOpenApiServiceAndChannelRelationAstiInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection/ASTI/serviceId/{serviceId}"
   ...
   * @param request A list of service channels. (optional)
   */
  public ApiResponse<V8VmOpenApiService> apiV8ConnectionASTIServiceSourceIdByServiceSourceIdPut(String serviceSourceId, V8VmOpenApiServiceAndChannelRelationBySourceAsti request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection/ASTI/serviceSourceId/{serviceSourceId}"
   ...
   */
  public ApiResponse<List<String>> apiV8ConnectionPost(List<V8VmOpenApiServiceAndChannelIn> request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection";
   ...
   * @param request A list of service channels. (optional)
   */
  public ApiResponse<V8VmOpenApiService> apiV8ConnectionServiceIdByServiceIdPut(String serviceId, V8VmOpenApiServiceAndChannelRelationInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection/serviceId/{serviceId}"
      .replaceAll("\\{" + "serviceId" + "\\}", serviceId);
   ...
   * @param request A list of service channels. (optional)
   */
  public ApiResponse<V8VmOpenApiService> apiV8ConnectionServiceSourceIdByServiceSourceIdPut(String serviceSourceId, V8VmOpenApiServiceAndChannelRelationBySourceInBase request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection/serviceSourceId/{serviceSourceId}"
      .replaceAll("\\{" + "serviceSourceId" + "\\}", serviceSourceId);
   ...
   * @param request A list of services and service channels. (optional)
   */
  public ApiResponse<List<String>> apiV8ConnectionSourcePost(List<V8VmOpenApiServiceAndChannelRelationBySource> request) {
    Map<String, Object> queryParams = new HashMap<>();
    Map<String, Object> formParams = new HashMap<>();
        
        
    String path = "/api/v8/Connection/Source";
