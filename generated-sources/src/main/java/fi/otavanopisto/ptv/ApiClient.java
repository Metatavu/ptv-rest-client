...
import fi.otavanopisto.ptv.auth.Authentication;
import fi.otavanopisto.ptv.auth.HttpBasicAuth;
import fi.otavanopisto.ptv.auth.ApiKeyAuth;
import fi.otavanopisto.ptv.auth.OAuth;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    setUserAgent("Swagger-Codegen/0.0.6/java");
